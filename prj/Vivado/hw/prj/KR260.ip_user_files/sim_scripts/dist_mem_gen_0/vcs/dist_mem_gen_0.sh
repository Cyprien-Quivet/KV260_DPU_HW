...
#
# Generated by Vivado on Mon Dec 08 04:52:26 PST 2025
...
# Design libraries
design_libs=(xilinx_vip xpm dist_mem_gen_v8_0_13 xil_defaultlib)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"/tools/Xilinx/Vivado/2022.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"/tools/Xilinx/Vivado/2022.2/data/xilinx_vip/include" \
  ...
  vlogan -work dist_mem_gen_v8_0_13 $vlogan_opts +v2k +incdir+"/tools/Xilinx/Vivado/2022.2/data/xilinx_vip/include" \
    "$ref_dir/../../../ipstatic/simulation/dist_mem_gen_v8_0.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/tools/Xilinx/Vivado/2022.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../KR260.gen/sources_1/ip/dist_mem_gen_0/sim/dist_mem_gen_0.v" \
  2>&1 | tee -a vlogan.log
