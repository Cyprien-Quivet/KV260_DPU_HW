...
# Set xvlog options
xvlog_opts="--incr --relax  -L axi_vip_v1_1_13 -L zynq_ultra_ps_e_vip_v1_0_13 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L dist_mem_gen_v8_0_13 -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dist_mem_gen_0 xil_defaultlib.dist_mem_gen_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim  dist_mem_gen_0 -key {Behavioral:sim_1:Functional:dist_mem_gen_0} -tclbatch cmd.tcl -protoinst "protoinst_files/top.protoinst" -log simulate.log
}
