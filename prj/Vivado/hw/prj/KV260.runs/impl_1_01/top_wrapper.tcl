namespace eval ::optrace {
  variable script "S:/prj/Vivado/hw/prj/KV260.runs/impl_1_01/top_wrapper.tcl"
...
proc step_failed { step } {
  ...
  set ch [open $endFile w]
  close $ch
OPTRACE "impl_1_01" END { }
}


OPTRACE "impl_1_01" START { ROLLUP_1 }
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir S:/prj/Vivado/hw/prj/KV260.cache/wt [current_project]
  set_property parent.project_path S:/prj/Vivado/hw/prj/KV260.xpr [current_project]
  set_property ip_repo_paths S:/dpu_ip [current_project]
  update_ip_catalog
  set_property ip_output_repo S:/prj/Vivado/hw/prj/KV260.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES XPM_CDC [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet S:/prj/Vivado/hw/prj/KV260.runs/synth_1/top_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files S:/prj/Vivado/hw/srcs/top/top.bd
  set_param project.isImplRun false
OPTRACE "read constraints: implementation" START { }
  read_xdc S:/prj/Vivado/hw/constrs/pin.xdc
  read_xdc S:/prj/Vivado/hw/constrs/misc.xdc
  read_xdc S:/prj/Vivado/hw/constrs/timing.xdc
  read_xdc S:/prj/Vivado/hw/constrs/debug.xdc
...
OPTRACE "link_design" START { }
  set_param project.isImplRun true
  link_design -top top_wrapper -part xck26-sfvc784-2LV-c 
...
OPTRACE "write_bitstream" START { }
  write_bitstream -force top_wrapper.bit -bin_file
