...
--Date        : Tue Nov 25 13:03:26 2025
--Host        : Petalinux running 64-bit Ubuntu 20.04.6 LTS
--Command     : generate_target axi_lite_led_simu.bd
--Design      : axi_lite_led_simu
...
entity axi_lite_led_simu is
  port (
    ...
    data_blinking_led_i_0 : in STD_LOGIC_VECTOR ( 31 downto 0 );
    data_config_period_o_0 : out STD_LOGIC_VECTOR ( 31 downto 0 );
    s00_axi_aclk_0 : in STD_LOGIC;
    s00_axi_aresetn_0 : in STD_LOGIC
  );
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of axi_lite_led_simu : entity is "axi_lite_led_simu,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=axi_lite_led_simu,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of axi_lite_led_simu : entity is "axi_lite_led_simu.hwdef";
end axi_lite_led_simu;

architecture STRUCTURE of axi_lite_led_simu is
  component axi_lite_led_simu_axi_lite_led_0_0 is
  port (
  ...
  end component axi_lite_led_simu_axi_lite_led_0_0;
  ...
  signal axi_lite_led_0_data_config_period_o : STD_LOGIC_VECTOR ( 31 downto 0 );
  signal data_blinking_led_i_0_1 : STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  attribute X_INTERFACE_PARAMETER of s00_axi_aclk_0 : signal is "XIL_INTERFACENAME CLK.S00_AXI_ACLK_0, ASSOCIATED_BUSIF S00_AXI_0, ASSOCIATED_RESET s00_axi_aresetn_0, CLK_DOMAIN axi_lite_led_simu_s00_axi_aclk_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
  ...
  attribute X_INTERFACE_PARAMETER of S00_AXI_0_araddr : signal is "XIL_INTERFACENAME S00_AXI_0, ADDR_WIDTH 16, ARUSER_WIDTH 0, AWUSER_WIDTH 0, BUSER_WIDTH 0, CLK_DOMAIN axi_lite_led_simu_s00_axi_aclk_0, DATA_WIDTH 32, FREQ_HZ 100000000, HAS_BRESP 1, HAS_BURST 0, HAS_CACHE 0, HAS_LOCK 0, HAS_PROT 1, HAS_QOS 0, HAS_REGION 0, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 0, INSERT_VIP 0, MAX_BURST_LENGTH 1, NUM_READ_OUTSTANDING 1, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 1, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4LITE, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 0, SUPPORTS_NARROW_BURST 0, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 0";
...
begin
  ...
  data_blinking_led_i_0_1(31 downto 0) <= data_blinking_led_i_0(31 downto 0);
  data_config_period_o_0(31 downto 0) <= axi_lite_led_0_data_config_period_o(31 downto 0);
  s00_axi_aclk_0_1 <= s00_axi_aclk_0;
  s00_axi_aresetn_0_1 <= s00_axi_aresetn_0;
axi_lite_led_0: component axi_lite_led_simu_axi_lite_led_0_0
     port map (
      data_blinking_led_i(31 downto 0) => data_blinking_led_i_0_1(31 downto 0),
      data_config_period_o(31 downto 0) => axi_lite_led_0_data_config_period_o(31 downto 0),
