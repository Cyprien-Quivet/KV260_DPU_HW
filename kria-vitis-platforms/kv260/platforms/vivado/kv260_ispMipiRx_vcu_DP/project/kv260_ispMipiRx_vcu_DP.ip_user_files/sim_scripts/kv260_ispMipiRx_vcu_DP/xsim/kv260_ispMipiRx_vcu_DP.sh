...
# Set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_13 -L zynq_ultra_ps_e_vip_v1_0_13 -L mipi_dphy_v4_3_5 -L smartconnect_v1_0 -L xilinx_vip"
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb kv260_ispMipiRx_vcu_DP.wdb xsim.dir)
