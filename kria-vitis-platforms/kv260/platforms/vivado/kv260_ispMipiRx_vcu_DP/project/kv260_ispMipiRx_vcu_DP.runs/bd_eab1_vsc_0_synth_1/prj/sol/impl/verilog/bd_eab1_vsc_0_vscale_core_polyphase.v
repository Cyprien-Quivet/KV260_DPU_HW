...
module bd_eab1_vsc_0_vscale_core_polyphase (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
reg   [10:0] InPixels_reg_621;
reg   [31:0] Rate_reg_626;
wire   [10:0] YLoopSize_fu_312_p2;
reg   [10:0] YLoopSize_reg_631;
wire   [16:0] InLines_cast_fu_318_p1;
reg   [16:0] InLines_cast_reg_636;
wire   [31:0] conv45_fu_322_p1;
reg   [31:0] conv45_reg_641;
wire   [31:0] WriteLocNext_2_fu_470_p3;
reg   [31:0] WriteLocNext_2_reg_649;
wire    ap_CS_fsm_state3;
wire   [0:0] icmp_ln214_fu_329_p2;
wire   [31:0] offset_5_fu_478_p3;
reg   [31:0] offset_5_reg_654;
wire   [0:0] OutputWriteEn_1_fu_502_p2;
reg   [0:0] OutputWriteEn_1_reg_659;
wire   [0:0] GetNewLine_2_fu_508_p3;
reg   [0:0] GetNewLine_2_reg_664;
wire   [5:0] empty_fu_532_p1;
reg   [5:0] empty_reg_669;
wire   [0:0] cmp119_fu_546_p2;
reg   [0:0] cmp119_reg_674;
wire   [0:0] cmp159_fu_551_p2;
reg   [0:0] cmp159_reg_679;
wire   [0:0] brmerge_fu_557_p2;
reg   [0:0] brmerge_reg_684;
...
wire   [7:0] PhaseV_1_fu_486_p3;
reg   [15:0] PixArrayLoc_fu_122;
wire   [15:0] PixArrayLoc_3_fu_494_p3;
reg   [10:0] y_fu_126;
wire   [10:0] y_2_fu_334_p2;
wire   [0:0] icmp_ln180_fu_298_p2;
wire   [10:0] TotalLines_fu_304_p3;
wire   [5:0] trunc_ln_fu_358_p4;
wire   [15:0] tmp_fu_372_p4;
wire   [0:0] GetNewLine_1_fu_382_p2;
wire   [31:0] offset_1_fu_394_p2;
wire   [15:0] PixArrayLoc_1_fu_388_p2;
wire   [31:0] offset_2_fu_400_p3;
wire   [15:0] tmp_6_fu_416_p4;
wire   [0:0] icmp_ln241_fu_426_p2;
wire   [0:0] icmp_ln241_1_fu_432_p2;
wire   [0:0] OutputWriteEn_fu_437_p2;
wire   [31:0] WriteLocNext_fu_448_p2;
wire   [31:0] offset_3_fu_443_p2;
wire   [0:0] icmp_ln222_fu_352_p2;
wire   [31:0] WriteLocNext_1_fu_454_p3;
wire   [31:0] offset_4_fu_462_p3;
wire   [7:0] zext_ln196_fu_368_p1;
wire   [15:0] PixArrayLoc_2_fu_408_p3;
wire   [8:0] tmp_7_fu_516_p4;
wire   [16:0] PixArrayLoc_2_cast_fu_536_p1;
wire   [16:0] add117_fu_540_p2;
wire   [0:0] icmp126_fu_526_p2;
reg   [4:0] ap_NS_fsm;
...
bd_eab1_vsc_0_vscale_core_polyphase_FiltCoeff_RAM_1P_LUTRAM_1R1W #(
    .DataWidth( 16 ),
    .AddressRange( 64 ),
    .AddressWidth( 6 ))
FiltCoeff_U(
...
bd_eab1_vsc_0_vscale_core_polyphase_LineBuf_val_V_RAM_AUTO_1R1W #(
    .DataWidth( 24 ),
    .AddressRange( 1920 ),
    .AddressWidth( 11 ))
LineBuf_val_V_U(
...
bd_eab1_vsc_0_vscale_core_polyphase_LineBuf_val_V_1_RAM_AUTO_1R1W #(
    .DataWidth( 24 ),
    .AddressRange( 1920 ),
    .AddressWidth( 11 ))
LineBuf_val_V_1_U(
...
bd_eab1_vsc_0_vscale_core_polyphase_Pipeline_loop_init_coeff_phase_loop_init_coeff_tap grp_vscale_core_polyphase_Pipeline_loop_init_coeff_phase_loop_init_coeff_tap_fu_229(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
bd_eab1_vsc_0_vscale_core_polyphase_Pipeline_loop_width_for_procpix grp_vscale_core_polyphase_Pipeline_loop_width_for_procpix_fu_247(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln214_fu_329_p2 == 1'd0))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((grp_vscale_core_polyphase_Pipeline_loop_width_for_procpix_fu_247_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
        GetNewLine_reg_218 <= GetNewLine_2_reg_664;
    end else if ((~((1'b0 == HwReg_HeightOut_c_full_n) | (1'b0 == HwReg_Width_c_full_n) | (1'b0 == LineRate_empty_n) | (1'b0 == HeightOut_empty_n) | (1'b0 == Width_empty_n) | (1'b0 == HeightIn_empty_n) | (grp_vscale_core_polyphase_Pipeline_loop_init_coeff_phase_loop_init_coeff_tap_fu_229_ap_done == 1'b0)) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if ((~((ap_done_reg == 1'b1) | (real_start == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        PhaseV_fu_118 <= 8'd0;
    end else if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln214_fu_329_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln214_fu_329_p2 == 1'd1))) begin
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        InLines_cast_reg_636[10 : 0] <= InLines_cast_fu_318_p1[10 : 0];
        InPixels_reg_621 <= Width_dout;
        Rate_reg_626 <= LineRate_dout;
        YLoopSize_reg_631 <= YLoopSize_fu_312_p2;
        conv45_reg_641[10 : 0] <= conv45_fu_322_p1[10 : 0];
    end
end
...
always @ (*) begin
    if ((~((1'b0 == HwReg_HeightOut_c_full_n) | (1'b0 == HwReg_Width_c_full_n) | (1'b0 == LineRate_empty_n) | (1'b0 == HeightOut_empty_n) | (1'b0 == Width_empty_n) | (1'b0 == HeightIn_empty_n) | (grp_vscale_core_polyphase_Pipeline_loop_init_coeff_phase_loop_init_coeff_tap_fu_229_ap_done == 1'b0)) & (1'b1 == ap_CS_fsm_state2))) begin
        HeightIn_read = 1'b1;
    end else begin
        HeightIn_read = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == HwReg_HeightOut_c_full_n) | (1'b0 == HwReg_Width_c_full_n) | (1'b0 == LineRate_empty_n) | (1'b0 == HeightOut_empty_n) | (1'b0 == Width_empty_n) | (1'b0 == HeightIn_empty_n) | (grp_vscale_core_polyphase_Pipeline_loop_init_coeff_phase_loop_init_coeff_tap_fu_229_ap_done == 1'b0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln214_fu_329_p2 == 1'd0))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign GetNewLine_1_fu_382_p2 = ((tmp_fu_372_p4 != 16'd0) ? 1'b1 : 1'b0);

assign GetNewLine_2_fu_508_p3 = ((icmp_ln222_fu_352_p2[0:0] == 1'b1) ? GetNewLine_1_fu_382_p2 : GetNewLine_reg_218);

assign HwReg_HeightOut_c_din = HeightOut_dout;

assign HwReg_Width_c_din = Width_dout;

assign InLines_cast_fu_318_p1 = HeightIn_dout;

assign OutYUV_din = grp_vscale_core_polyphase_Pipeline_loop_width_for_procpix_fu_247_OutYUV_din;

assign OutputWriteEn_1_fu_502_p2 = (icmp_ln222_fu_352_p2 & OutputWriteEn_fu_437_p2);

assign OutputWriteEn_fu_437_p2 = (icmp_ln241_fu_426_p2 & icmp_ln241_1_fu_432_p2);

assign PhaseV_1_fu_486_p3 = ((icmp_ln222_fu_352_p2[0:0] == 1'b1) ? zext_ln196_fu_368_p1 : PhaseV_fu_118);

assign PixArrayLoc_1_fu_388_p2 = (PixArrayLoc_fu_122 + 16'd1);

assign PixArrayLoc_2_cast_fu_536_p1 = PixArrayLoc_3_fu_494_p3;

assign PixArrayLoc_2_fu_408_p3 = ((GetNewLine_1_fu_382_p2[0:0] == 1'b1) ? PixArrayLoc_1_fu_388_p2 : PixArrayLoc_fu_122);

assign PixArrayLoc_3_fu_494_p3 = ((icmp_ln222_fu_352_p2[0:0] == 1'b1) ? PixArrayLoc_2_fu_408_p3 : PixArrayLoc_fu_122);

assign TotalLines_fu_304_p3 = ((icmp_ln180_fu_298_p2[0:0] == 1'b1) ? HeightOut_dout : HeightIn_dout);

assign WriteLocNext_1_fu_454_p3 = ((OutputWriteEn_fu_437_p2[0:0] == 1'b1) ? WriteLocNext_fu_448_p2 : WriteLoc_fu_110);

assign WriteLocNext_2_fu_470_p3 = ((icmp_ln222_fu_352_p2[0:0] == 1'b1) ? WriteLocNext_1_fu_454_p3 : WriteLoc_fu_110);

assign WriteLocNext_fu_448_p2 = (WriteLoc_fu_110 + 32'd1);

assign YLoopSize_fu_312_p2 = (TotalLines_fu_304_p3 + 11'd3);

assign add117_fu_540_p2 = (PixArrayLoc_2_cast_fu_536_p1 + 17'd3);
...
always @ (*) begin
    ap_block_state1_ignore_call42 = ((ap_done_reg == 1'b1) | (real_start == 1'b0));
end

always @ (*) begin
    ap_block_state2 = ((1'b0 == HwReg_HeightOut_c_full_n) | (1'b0 == HwReg_Width_c_full_n) | (1'b0 == LineRate_empty_n) | (1'b0 == HeightOut_empty_n) | (1'b0 == Width_empty_n) | (1'b0 == HeightIn_empty_n));
end

assign ap_ready = internal_ap_ready;

assign brmerge_fu_557_p2 = (icmp126_fu_526_p2 | GetNewLine_2_fu_508_p3);

assign cmp119_fu_546_p2 = ((add117_fu_540_p2 < InLines_cast_reg_636) ? 1'b1 : 1'b0);

assign cmp159_fu_551_p2 = ((y_fu_126 != 11'd0) ? 1'b1 : 1'b0);

assign conv45_fu_322_p1 = HeightOut_dout;

assign empty_fu_532_p1 = PhaseV_1_fu_486_p3[5:0];
...
assign icmp126_fu_526_p2 = ((tmp_7_fu_516_p4 == 9'd0) ? 1'b1 : 1'b0);

assign icmp_ln180_fu_298_p2 = ((HeightOut_dout > HeightIn_dout) ? 1'b1 : 1'b0);

assign icmp_ln214_fu_329_p2 = ((y_fu_126 < YLoopSize_reg_631) ? 1'b1 : 1'b0);

assign icmp_ln222_fu_352_p2 = ((y_fu_126 > 11'd2) ? 1'b1 : 1'b0);

assign icmp_ln241_1_fu_432_p2 = ((WriteLoc_fu_110 < conv45_reg_641) ? 1'b1 : 1'b0);

assign icmp_ln241_fu_426_p2 = ((tmp_6_fu_416_p4 == 16'd0) ? 1'b1 : 1'b0);

assign offset_1_fu_394_p2 = ($signed(offset_fu_114) + $signed(32'd4294901760));

assign offset_2_fu_400_p3 = ((GetNewLine_1_fu_382_p2[0:0] == 1'b1) ? offset_1_fu_394_p2 : offset_fu_114);

assign offset_3_fu_443_p2 = (offset_2_fu_400_p3 + Rate_reg_626);

assign offset_4_fu_462_p3 = ((OutputWriteEn_fu_437_p2[0:0] == 1'b1) ? offset_3_fu_443_p2 : offset_2_fu_400_p3);

assign offset_5_fu_478_p3 = ((icmp_ln222_fu_352_p2[0:0] == 1'b1) ? offset_4_fu_462_p3 : offset_fu_114);

assign start_out = real_start;

assign tmp_6_fu_416_p4 = {{offset_2_fu_400_p3[31:16]}};

assign tmp_7_fu_516_p4 = {{y_fu_126[10:2]}};

assign tmp_fu_372_p4 = {{offset_fu_114[31:16]}};

assign trunc_ln_fu_358_p4 = {{offset_fu_114[15:10]}};
...
assign y_2_fu_334_p2 = (y_fu_126 + 11'd1);

assign zext_ln196_fu_368_p1 = trunc_ln_fu_358_p4;

always @ (posedge ap_clk) begin
    InLines_cast_reg_636[16:11] <= 6'b000000;
    conv45_reg_641[31:11] <= 21'b000000000000000000000;
end

endmodule //bd_eab1_vsc_0_vscale_core_polyphase
