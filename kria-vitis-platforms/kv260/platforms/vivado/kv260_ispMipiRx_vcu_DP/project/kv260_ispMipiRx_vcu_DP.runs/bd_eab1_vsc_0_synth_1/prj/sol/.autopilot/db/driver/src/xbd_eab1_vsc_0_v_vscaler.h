...
// ==============================================================
#ifndef XBD_EAB1_VSC_0_V_VSCALER_H
#define XBD_EAB1_VSC_0_V_VSCALER_H
...
#include <stddef.h>
#endif
#include "xbd_eab1_vsc_0_v_vscaler_hw.h"
...
typedef struct {
    u16 DeviceId;
    u64 Bd_eab1_vsc_0_ctrl_BaseAddress;
} XBd_eab1_vsc_0_v_vscaler_Config;
#endif

typedef struct {
    u64 Bd_eab1_vsc_0_ctrl_BaseAddress;
    u32 IsReady;
} XBd_eab1_vsc_0_v_vscaler;

typedef u32 word_type;

/***************** Macros (Inline Functions) Definitions *********************/
#ifndef __linux__
#define XBd_eab1_vsc_0_v_vscaler_WriteReg(BaseAddress, RegOffset, Data) \
    Xil_Out32((BaseAddress) + (RegOffset), (u32)(Data))
#define XBd_eab1_vsc_0_v_vscaler_ReadReg(BaseAddress, RegOffset) \
