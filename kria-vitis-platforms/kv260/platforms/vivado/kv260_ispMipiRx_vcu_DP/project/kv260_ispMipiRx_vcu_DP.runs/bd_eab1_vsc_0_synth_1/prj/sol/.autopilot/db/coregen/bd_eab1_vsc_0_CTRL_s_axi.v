...
// ==============================================================
`timescale 1ns/1ps
module bd_eab1_vsc_0_CTRL_s_axi
#(parameter
...
//------------------------Local signal-------------------
    ...
    reg  [0:0]                    int_vfltCoeff_shift0;

//------------------------Instantiation------------------
// int_vfltCoeff
bd_eab1_vsc_0_CTRL_s_axi_ram #(
    .MEM_STYLE ( "auto" ),
    .MEM_TYPE  ( "2P" ),
    .BYTES     ( 4 ),
    .DEPTH     ( 192 )
...
assign vfltCoeff_q0           = int_vfltCoeff_q0 >> (int_vfltCoeff_shift0 * 16);
...
assign int_vfltCoeff_be1      = int_vfltCoeff_we1 ? WSTRB : 'b0;
...
// int_vfltCoeff_shift0
always @(posedge ACLK) begin
    if (ARESET)
        int_vfltCoeff_shift0 <= 1'b0;
    else if (ACLK_EN) begin
        if (vfltCoeff_ce0)
            int_vfltCoeff_shift0 <= vfltCoeff_address0[0];
    end
end
...
module bd_eab1_vsc_0_CTRL_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,
