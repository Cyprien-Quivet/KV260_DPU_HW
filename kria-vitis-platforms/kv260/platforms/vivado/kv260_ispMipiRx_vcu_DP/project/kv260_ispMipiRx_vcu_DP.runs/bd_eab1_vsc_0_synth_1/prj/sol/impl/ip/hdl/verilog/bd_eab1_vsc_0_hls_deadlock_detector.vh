...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    bd_eab1_vsc_0_hls_deadlock_detect_unit #(5, 0, 3, 3) bd_eab1_vsc_0_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~Block_entry4_proc_U0.HwReg_LineRate_blk_n) | (~Block_entry4_proc_U0.HwReg_HeightOut_c19_blk_n);
    assign proc_0_data_PIPO_blk[0] = 1'b0;
    assign proc_0_start_FIFO_blk[0] = 1'b0;
    assign proc_0_TLF_FIFO_blk[0] = 1'b0;
    assign proc_0_input_sync_blk[0] = 1'b0 | (ap_sync_Block_entry4_proc_U0_ap_ready & Block_entry4_proc_U0.ap_idle & ~ap_sync_vscale_core_polyphase_U0_ap_ready);
    assign proc_0_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_0[0] = dl_detect_out ? proc_dep_vld_vec_0_reg[0] : (proc_0_data_FIFO_blk[0] | proc_0_data_PIPO_blk[0] | proc_0_start_FIFO_blk[0] | proc_0_TLF_FIFO_blk[0] | proc_0_input_sync_blk[0] | proc_0_output_sync_blk[0]);
    assign proc_0_data_FIFO_blk[1] = 1'b0 | (~Block_entry4_proc_U0.HwReg_HeightIn_c15_blk_n) | (~Block_entry4_proc_U0.HwReg_Width_c18_blk_n) | (~Block_entry4_proc_U0.HwReg_ColorMode_c20_blk_n);
    assign proc_0_data_PIPO_blk[1] = 1'b0;
    assign proc_0_start_FIFO_blk[1] = 1'b0 | (~start_for_AXIvideo2MultiPixStream_U0_U.if_full_n & Block_entry4_proc_U0.ap_start & ~Block_entry4_proc_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_AXIvideo2MultiPixStream_U0_U.if_read);
    assign proc_0_TLF_FIFO_blk[1] = 1'b0;
    assign proc_0_input_sync_blk[1] = 1'b0;
    assign proc_0_output_sync_blk[1] = 1'b0;
    assign proc_dep_vld_vec_0[1] = dl_detect_out ? proc_dep_vld_vec_0_reg[1] : (proc_0_data_FIFO_blk[1] | proc_0_data_PIPO_blk[1] | proc_0_start_FIFO_blk[1] | proc_0_TLF_FIFO_blk[1] | proc_0_input_sync_blk[1] | proc_0_output_sync_blk[1]);
    assign proc_0_data_FIFO_blk[2] = 1'b0 | (~Block_entry4_proc_U0.ColorMode_vcr_c21_blk_n);
    assign proc_0_data_PIPO_blk[2] = 1'b0;
    assign proc_0_start_FIFO_blk[2] = 1'b0 | (~start_for_v_vcresampler_core_U0_U.if_full_n & Block_entry4_proc_U0.ap_start & ~Block_entry4_proc_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_v_vcresampler_core_U0_U.if_read);
    ...
    bd_eab1_vsc_0_hls_deadlock_detect_unit #(5, 1, 2, 2) bd_eab1_vsc_0_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~AXIvideo2MultiPixStream_U0.grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_233.SrcYUV_blk_n) | (~AXIvideo2MultiPixStream_U0.HwReg_HeightIn_c14_blk_n) | (~AXIvideo2MultiPixStream_U0.HwReg_Width_c17_blk_n) | (~AXIvideo2MultiPixStream_U0.HwReg_ColorMode_c_blk_n);
    ...
    bd_eab1_vsc_0_hls_deadlock_detect_unit #(5, 2, 4, 4) bd_eab1_vsc_0_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~v_vcresampler_core_U0.grp_v_vcresampler_core_Pipeline_VITIS_LOOP_1012_2_fu_176.SrcYUV_blk_n) | (~v_vcresampler_core_U0.height_blk_n) | (~v_vcresampler_core_U0.width_blk_n) | (~v_vcresampler_core_U0.inColorMode_blk_n);
    ...
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~v_vcresampler_core_U0.outColorMode_blk_n);
    assign proc_2_data_PIPO_blk[1] = 1'b0;
    assign proc_2_start_FIFO_blk[1] = 1'b0 | (~start_for_v_vcresampler_core_U0_U.if_empty_n & v_vcresampler_core_U0.ap_idle & ~start_for_v_vcresampler_core_U0_U.if_write);
    assign proc_2_TLF_FIFO_blk[1] = 1'b0;
    assign proc_2_input_sync_blk[1] = 1'b0;
    assign proc_2_output_sync_blk[1] = 1'b0;
    assign proc_dep_vld_vec_2[1] = dl_detect_out ? proc_dep_vld_vec_2_reg[1] : (proc_2_data_FIFO_blk[1] | proc_2_data_PIPO_blk[1] | proc_2_start_FIFO_blk[1] | proc_2_TLF_FIFO_blk[1] | proc_2_input_sync_blk[1] | proc_2_output_sync_blk[1]);
    assign proc_2_data_FIFO_blk[2] = 1'b0 | (~v_vcresampler_core_U0.grp_v_vcresampler_core_Pipeline_VITIS_LOOP_1012_2_fu_176.SrcYUV422_blk_n) | (~v_vcresampler_core_U0.HwReg_HeightIn_c_blk_n) | (~v_vcresampler_core_U0.HwReg_Width_c16_blk_n);
    ...
    assign proc_2_data_FIFO_blk[3] = 1'b0 | (~v_vcresampler_core_U0.ColorMode_vcr_c_blk_n);
    ...
    bd_eab1_vsc_0_hls_deadlock_detect_unit #(5, 3, 3, 3) bd_eab1_vsc_0_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~vscale_core_polyphase_U0.grp_vscale_core_polyphase_Pipeline_loop_width_for_procpix_fu_247.SrcYUV422_blk_n) | (~vscale_core_polyphase_U0.HeightIn_blk_n) | (~vscale_core_polyphase_U0.Width_blk_n);
    ...
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~vscale_core_polyphase_U0.HeightOut_blk_n) | (~vscale_core_polyphase_U0.LineRate_blk_n);
    assign proc_3_data_PIPO_blk[1] = 1'b0;
    assign proc_3_start_FIFO_blk[1] = 1'b0;
    assign proc_3_TLF_FIFO_blk[1] = 1'b0;
    assign proc_3_input_sync_blk[1] = 1'b0 | (ap_sync_vscale_core_polyphase_U0_ap_ready & vscale_core_polyphase_U0.ap_idle & ~ap_sync_Block_entry4_proc_U0_ap_ready);
    assign proc_3_output_sync_blk[1] = 1'b0;
    assign proc_dep_vld_vec_3[1] = dl_detect_out ? proc_dep_vld_vec_3_reg[1] : (proc_3_data_FIFO_blk[1] | proc_3_data_PIPO_blk[1] | proc_3_start_FIFO_blk[1] | proc_3_TLF_FIFO_blk[1] | proc_3_input_sync_blk[1] | proc_3_output_sync_blk[1]);
    assign proc_3_data_FIFO_blk[2] = 1'b0 | (~vscale_core_polyphase_U0.grp_vscale_core_polyphase_Pipeline_loop_width_for_procpix_fu_247.OutYUV_blk_n) | (~vscale_core_polyphase_U0.HwReg_Width_c_blk_n) | (~vscale_core_polyphase_U0.HwReg_HeightOut_c_blk_n);
    assign proc_3_data_PIPO_blk[2] = 1'b0;
    assign proc_3_start_FIFO_blk[2] = 1'b0 | (~start_for_MultiPixStream2AXIvideo_U0_U.if_full_n & vscale_core_polyphase_U0.ap_start & ~vscale_core_polyphase_U0.real_start & (trans_in_cnt_1 == trans_out_cnt_1) & ~start_for_MultiPixStream2AXIvideo_U0_U.if_read);
    ...
    bd_eab1_vsc_0_hls_deadlock_detect_unit #(5, 4, 2, 2) bd_eab1_vsc_0_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~MultiPixStream2AXIvideo_U0.grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_895_2_fu_108.OutYUV_blk_n) | (~MultiPixStream2AXIvideo_U0.Height_blk_n) | (~MultiPixStream2AXIvideo_U0.Width_blk_n);
...
`include "bd_eab1_vsc_0_hls_deadlock_report_unit.vh"
