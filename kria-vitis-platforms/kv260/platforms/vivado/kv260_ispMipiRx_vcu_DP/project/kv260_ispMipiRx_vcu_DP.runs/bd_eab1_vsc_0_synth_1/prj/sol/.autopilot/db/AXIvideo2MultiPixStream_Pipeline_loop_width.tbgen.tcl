...
set C_modelArgList {
	...
	{ axi_data_V_14 int 24 regular  }
	{ cols int 11 regular  }
	{ icmp_ln797 int 1 regular  }
	{ icmp_ln797_1 int 1 regular  }
	...
	{ axi_data_V_15_out int 24 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sof_5", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_V_14", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "cols", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	{ "Name" : "icmp_ln797", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "icmp_ln797_1", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_V_15_out", "interface" : "wire", "bitwidth" : 24, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ SrcYUV_din sc_out sc_lv 24 signal 6 } 
	{ SrcYUV_num_data_valid sc_in sc_lv 5 signal 6 } 
	{ SrcYUV_fifo_cap sc_in sc_lv 5 signal 6 } 
	{ SrcYUV_full_n sc_in sc_logic 1 signal 6 } 
	{ SrcYUV_write sc_out sc_logic 1 signal 6 } 
	{ sof_5 sc_in sc_lv 1 signal 0 } 
	{ axi_last_V_2 sc_in sc_lv 1 signal 1 } 
	{ axi_data_V_14 sc_in sc_lv 24 signal 2 } 
	{ cols sc_in sc_lv 11 signal 3 } 
	{ icmp_ln797 sc_in sc_lv 1 signal 4 } 
	{ icmp_ln797_1 sc_in sc_lv 1 signal 5 } 
	...
	{ axi_data_V_15_out sc_out sc_lv 24 signal 15 } 
	{ axi_data_V_15_out_ap_vld sc_out sc_logic 1 outvld 15 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "axi_data_V_14", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "axi_data_V_14", "role": "default" }} , 
 	{ "name": "cols", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "cols", "role": "default" }} , 
 	{ "name": "icmp_ln797", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "icmp_ln797", "role": "default" }} , 
 	{ "name": "icmp_ln797_1", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "icmp_ln797_1", "role": "default" }} , 
 	...
 	{ "name": "axi_data_V_15_out", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "axi_data_V_15_out", "role": "default" }} , 
 	{ "name": "axi_data_V_15_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "axi_data_V_15_out", "role": "ap_vld" }}  ]}
...
set Spec2ImplPortList { 
	...
	axi_data_V_14 { ap_none {  { axi_data_V_14 in_data 0 24 } } }
	cols { ap_none {  { cols in_data 0 11 } } }
	icmp_ln797 { ap_none {  { icmp_ln797 in_data 0 1 } } }
	icmp_ln797_1 { ap_none {  { icmp_ln797_1 in_data 0 1 } } }
	...
	axi_data_V_15_out { ap_vld {  { axi_data_V_15_out out_data 1 24 }  { axi_data_V_15_out_ap_vld out_vld 1 1 } } }
}
