...
using hls::sim::Byte;
extern "C" void v_vscaler(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, Byte<2>*, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
...
std::vector<Byte<2>> __xlx_vfltCoeff__tmp_vec;
for (size_t i = 0; i < 384; ++i){
__xlx_vfltCoeff__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_vfltCoeff)[i]);
}
...
for (size_t i = 0; i < __xlx_size_param_vfltCoeff; ++i) {
((Byte<2>*)__xlx_apatb_param_vfltCoeff)[i] = __xlx_vfltCoeff__tmp_vec[__xlx_offset_param_vfltCoeff+i];
}
