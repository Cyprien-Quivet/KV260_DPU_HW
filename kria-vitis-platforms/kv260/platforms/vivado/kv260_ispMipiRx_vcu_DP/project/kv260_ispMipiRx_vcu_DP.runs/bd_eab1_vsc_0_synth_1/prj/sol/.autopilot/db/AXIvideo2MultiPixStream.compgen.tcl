...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_SrcYUV \
    op interface \
    ports { SrcYUV_din { O 24 vector } SrcYUV_num_data_valid { I 5 vector } SrcYUV_fifo_cap { I 5 vector } SrcYUV_full_n { I 1 bit } SrcYUV_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_WidthIn \
    op interface \
    ports { WidthIn_dout { I 11 vector } WidthIn_num_data_valid { I 2 vector } WidthIn_fifo_cap { I 2 vector } WidthIn_empty_n { I 1 bit } WidthIn_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ColorMode_dout { I 8 vector } ColorMode_num_data_valid { I 2 vector } ColorMode_fifo_cap { I 2 vector } ColorMode_empty_n { I 1 bit } ColorMode_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 61 \
    name HwReg_HeightIn_c14 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_HwReg_HeightIn_c14 \
    op interface \
    ports { HwReg_HeightIn_c14_din { O 11 vector } HwReg_HeightIn_c14_num_data_valid { I 2 vector } HwReg_HeightIn_c14_fifo_cap { I 2 vector } HwReg_HeightIn_c14_full_n { I 1 bit } HwReg_HeightIn_c14_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 62 \
    name HwReg_Width_c17 \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_HwReg_Width_c17 \
    op interface \
    ports { HwReg_Width_c17_din { O 11 vector } HwReg_Width_c17_num_data_valid { I 2 vector } HwReg_Width_c17_fifo_cap { I 2 vector } HwReg_Width_c17_full_n { I 1 bit } HwReg_Width_c17_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 63 \
    name HwReg_ColorMode_c \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_HwReg_ColorMode_c \
    op interface \
    ports { HwReg_ColorMode_c_din { O 8 vector } HwReg_ColorMode_c_num_data_valid { I 2 vector } HwReg_ColorMode_c_fifo_cap { I 2 vector } HwReg_ColorMode_c_full_n { I 1 bit } HwReg_ColorMode_c_write { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 64
set RegSliceName bd_eab1_vsc_0_regslice_both
set RegSliceInstName bd_eab1_vsc_0_regslice_both_U
set CoreName ap_simcore_bd_eab1_vsc_0_regslice_both
