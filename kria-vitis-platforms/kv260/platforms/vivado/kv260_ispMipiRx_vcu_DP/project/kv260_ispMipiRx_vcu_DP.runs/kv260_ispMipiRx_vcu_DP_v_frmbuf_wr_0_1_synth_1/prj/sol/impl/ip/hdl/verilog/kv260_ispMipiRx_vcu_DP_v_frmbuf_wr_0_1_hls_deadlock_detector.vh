...
reg [15:0] trans_in_cnt_0;// for process grp_FrmbufWrHlsDataFlow_fu_166.entry_proc_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_0 <= 16'h0;
    end
    else if (grp_FrmbufWrHlsDataFlow_fu_166.entry_proc_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_0;// for process grp_FrmbufWrHlsDataFlow_fu_166.entry_proc_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_0 <= 16'h0;
    end
    else if (grp_FrmbufWrHlsDataFlow_fu_166.entry_proc_U0.ap_done == 1'b1 && grp_FrmbufWrHlsDataFlow_fu_166.entry_proc_U0.ap_continue == 1'b1) begin
    ...
    // Process: grp_FrmbufWrHlsDataFlow_fu_166.entry_proc_U0
    kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_hls_deadlock_detect_unit #(4, 0, 3, 3) kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_input_sync_blk[2] = 1'b0 | (grp_FrmbufWrHlsDataFlow_fu_166.ap_sync_entry_proc_U0_ap_ready & grp_FrmbufWrHlsDataFlow_fu_166.entry_proc_U0.ap_idle & ~grp_FrmbufWrHlsDataFlow_fu_166.ap_sync_AXIvideo2MultiPixStream_U0_ap_ready);
    ...
    // Process: grp_FrmbufWrHlsDataFlow_fu_166.AXIvideo2MultiPixStream_U0
    kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_hls_deadlock_detect_unit #(4, 1, 2, 2) kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~grp_FrmbufWrHlsDataFlow_fu_166.AXIvideo2MultiPixStream_U0.grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_218.img_blk_n) | (~grp_FrmbufWrHlsDataFlow_fu_166.AXIvideo2MultiPixStream_U0.width_c_blk_n) | (~grp_FrmbufWrHlsDataFlow_fu_166.AXIvideo2MultiPixStream_U0.height_c10_blk_n);
    ...
    assign proc_1_input_sync_blk[1] = 1'b0 | (grp_FrmbufWrHlsDataFlow_fu_166.ap_sync_AXIvideo2MultiPixStream_U0_ap_ready & grp_FrmbufWrHlsDataFlow_fu_166.AXIvideo2MultiPixStream_U0.ap_idle & ~grp_FrmbufWrHlsDataFlow_fu_166.ap_sync_entry_proc_U0_ap_ready);
    ...
    // Process: grp_FrmbufWrHlsDataFlow_fu_166.MultiPixStream2Bytes_U0
    kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_hls_deadlock_detect_unit #(4, 2, 3, 3) kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~grp_FrmbufWrHlsDataFlow_fu_166.MultiPixStream2Bytes_U0.grp_MultiPixStream2Bytes_Pipeline_VITIS_LOOP_586_1_fu_346.img_blk_n) | (~grp_FrmbufWrHlsDataFlow_fu_166.MultiPixStream2Bytes_U0.Height_blk_n) | (~grp_FrmbufWrHlsDataFlow_fu_166.MultiPixStream2Bytes_U0.WidthInPix_blk_n);
    ...
    // Process: grp_FrmbufWrHlsDataFlow_fu_166.Bytes2AXIMMvideo_U0
    kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_hls_deadlock_detect_unit #(4, 3, 2, 2) kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~grp_FrmbufWrHlsDataFlow_fu_166.Bytes2AXIMMvideo_U0.grp_Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1117_1_fu_204.bytePlanes_plane01_blk_n) | (~grp_FrmbufWrHlsDataFlow_fu_166.Bytes2AXIMMvideo_U0.grp_Bytes2AXIMMvideo_Pipeline_VITIS_LOOP_1127_2_fu_214.bytePlanes_plane12_blk_n) | (~grp_FrmbufWrHlsDataFlow_fu_166.Bytes2AXIMMvideo_U0.Height_blk_n) | (~grp_FrmbufWrHlsDataFlow_fu_166.Bytes2AXIMMvideo_U0.WidthInBytes_blk_n) | (~grp_FrmbufWrHlsDataFlow_fu_166.Bytes2AXIMMvideo_U0.VideoFormat_blk_n);
...
`include "kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_hls_deadlock_report_unit.vh"
