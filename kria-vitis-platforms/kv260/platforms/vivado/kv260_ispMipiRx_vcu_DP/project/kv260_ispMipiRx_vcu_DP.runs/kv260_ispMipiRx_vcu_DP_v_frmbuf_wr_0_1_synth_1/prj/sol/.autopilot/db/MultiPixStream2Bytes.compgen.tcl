...
set id 121
set name kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_mul_mul_12ns_13ns_25_4_1
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { WidthInBytes_dout { I 14 vector } WidthInBytes_num_data_valid { I 3 vector } WidthInBytes_fifo_cap { I 3 vector } WidthInBytes_empty_n { I 1 bit } WidthInBytes_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { WidthInBytes_c_din { O 14 vector } WidthInBytes_c_num_data_valid { I 2 vector } WidthInBytes_c_fifo_cap { I 2 vector } WidthInBytes_c_full_n { I 1 bit } WidthInBytes_c_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { height_c_din { O 11 vector } height_c_num_data_valid { I 2 vector } height_c_fifo_cap { I 2 vector } height_c_full_n { I 1 bit } height_c_write { O 1 bit } } \
} "
}
