...
entity kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_FrmbufWrHlsDataFlow is
port (
...
architecture behav of kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_FrmbufWrHlsDataFlow is 
...
attribute shreg_extract : string;
    ...
    signal entry_proc_U0_WidthInBytes_c9_din : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal AXIvideo2MultiPixStream_U0_height_c10_din : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal MultiPixStream2Bytes_U0_WidthInBytes_c_din : STD_LOGIC_VECTOR (13 downto 0);
    signal MultiPixStream2Bytes_U0_WidthInBytes_c_write : STD_LOGIC;
    signal MultiPixStream2Bytes_U0_height_c_din : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal WidthInBytes_c9_dout : STD_LOGIC_VECTOR (13 downto 0);
    ...
    signal height_c10_dout : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal bytePlanes_plane0_num_data_valid : STD_LOGIC_VECTOR (9 downto 0);
    signal bytePlanes_plane0_fifo_cap : STD_LOGIC_VECTOR (9 downto 0);
    ...
    signal bytePlanes_plane1_num_data_valid : STD_LOGIC_VECTOR (9 downto 0);
    signal bytePlanes_plane1_fifo_cap : STD_LOGIC_VECTOR (9 downto 0);
    signal bytePlanes_plane1_empty_n : STD_LOGIC;
    signal WidthInBytes_c_full_n : STD_LOGIC;
    signal WidthInBytes_c_dout : STD_LOGIC_VECTOR (13 downto 0);
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_entry_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
        ...
        p_read : IN STD_LOGIC_VECTOR (13 downto 0);
        WidthInBytes_c9_din : OUT STD_LOGIC_VECTOR (13 downto 0);
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_AXIvideo2MultiPixStream IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_MultiPixStream2Bytes IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_Bytes2AXIMMvideo IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w32_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w14_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w16_d4_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w6_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w24_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w3_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w11_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w64_d480_B IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w14_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w6_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_start_for_MultiPixStream2Bytes_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_start_for_Bytes2AXIMMvideo_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    entry_proc_U0 : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_entry_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    AXIvideo2MultiPixStream_U0 : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_AXIvideo2MultiPixStream
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    MultiPixStream2Bytes_U0 : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_MultiPixStream2Bytes
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    Bytes2AXIMMvideo_U0 : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_Bytes2AXIMMvideo
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    HwReg_frm_buffer_c_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w32_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    HwReg_frm_buffer2_c_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w32_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    WidthInBytes_c9_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w14_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    stride_c_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w16_d4_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    video_format_c11_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w6_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    img_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w24_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    width_c_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w3_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    height_c10_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w11_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    bytePlanes_plane0_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w64_d480_B
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    bytePlanes_plane1_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w64_d480_B
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    WidthInBytes_c_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w14_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    height_c_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w11_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    video_format_c_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w6_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_MultiPixStream2Bytes_U0_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_start_for_MultiPixStream2Bytes_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Bytes2AXIMMvideo_U0_U : component kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_start_for_Bytes2AXIMMvideo_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
