...
set C_modelArgList {
	...
	{ WidthInBytes_c9 int 14 regular {fifo 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "HwReg_frm_buffer", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "WidthInBytes_c9", "interface" : "fifo", "bitwidth" : 14, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ p_read sc_in sc_lv 14 signal 4 } 
	{ WidthInBytes_c9_din sc_out sc_lv 14 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "WidthInBytes_c9_din", "direction": "out", "datatype": "sc_lv", "bitwidth":14, "type": "signal", "bundle":{"name": "WidthInBytes_c9", "role": "din" }} , 
...
set Spec2ImplPortList { 
	...
	WidthInBytes_c9 { ap_fifo {  { WidthInBytes_c9_din fifo_port_we 1 14 }  { WidthInBytes_c9_num_data_valid fifo_status_num_data_valid 0 3 }  { WidthInBytes_c9_fifo_cap fifo_update 0 3 }  { WidthInBytes_c9_full_n fifo_status 0 1 }  { WidthInBytes_c9_write fifo_data 1 1 } } }
