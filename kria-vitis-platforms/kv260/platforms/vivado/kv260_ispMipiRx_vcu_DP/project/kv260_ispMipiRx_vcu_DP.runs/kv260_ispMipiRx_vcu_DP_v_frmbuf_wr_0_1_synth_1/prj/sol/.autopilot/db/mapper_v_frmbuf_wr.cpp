...
using hls::sim::Byte;
extern "C" void v_frmbuf_wr(Byte<8>*, short, short, short, short, int, int, int, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
