...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_width_c \
    op interface \
    ports { width_c_din { O 3 vector } width_c_num_data_valid { I 2 vector } width_c_fifo_cap { I 2 vector } width_c_full_n { I 1 bit } width_c_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { height_c10_din { O 11 vector } height_c10_num_data_valid { I 2 vector } height_c10_fifo_cap { I 2 vector } height_c10_full_n { I 1 bit } height_c10_write { O 1 bit } } \
} "
}
