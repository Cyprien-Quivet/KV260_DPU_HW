...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bytePlanes_plane01_dout { I 64 vector } bytePlanes_plane01_num_data_valid { I 10 vector } bytePlanes_plane01_fifo_cap { I 10 vector } bytePlanes_plane01_empty_n { I 1 bit } bytePlanes_plane01_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { bytePlanes_plane12_dout { I 64 vector } bytePlanes_plane12_num_data_valid { I 10 vector } bytePlanes_plane12_fifo_cap { I 10 vector } bytePlanes_plane12_empty_n { I 1 bit } bytePlanes_plane12_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { WidthInBytes_dout { I 14 vector } WidthInBytes_num_data_valid { I 2 vector } WidthInBytes_fifo_cap { I 2 vector } WidthInBytes_empty_n { I 1 bit } WidthInBytes_read { O 1 bit } } \
} "
}
