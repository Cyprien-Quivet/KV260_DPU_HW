...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w32_d4_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {HwReg_frm_buffer_c_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w32_d4_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {HwReg_frm_buffer2_c_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w14_d3_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {WidthInBytes_c9_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w16_d4_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {stride_c_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w6_d3_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {video_format_c11_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w24_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {img_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w3_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {width_c_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w11_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {height_c10_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w64_d480_B BINDTYPE {storage} TYPE {fifo} IMPL {bram} ALLOW_PRAGMA 1 INSTNAME {bytePlanes_plane0_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w64_d480_B BINDTYPE {storage} TYPE {fifo} IMPL {bram} ALLOW_PRAGMA 1 INSTNAME {bytePlanes_plane1_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w14_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {WidthInBytes_c_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w11_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {height_c_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_fifo_w6_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {video_format_c_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_start_for_MultiPixStream2Bytes_U0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {start_for_MultiPixStream2Bytes_U0_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_start_for_Bytes2AXIMMvideo_U0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {start_for_Bytes2AXIMMvideo_U0_U}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_p_read \
    op interface \
    ports { p_read { I 14 vector } p_read_ap_vld { I 1 bit } } \
} "
}
