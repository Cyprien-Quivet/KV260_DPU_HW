...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_in_din { O 24 vector } stream_in_num_data_valid { I 5 vector } stream_in_fifo_cap { I 5 vector } stream_in_full_n { I 1 bit } stream_in_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_Height_c20 \
    op interface \
    ports { Height_c20_din { O 16 vector } Height_c20_num_data_valid { I 2 vector } Height_c20_fifo_cap { I 2 vector } Height_c20_full_n { I 1 bit } Height_c20_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_WidthIn_c \
    op interface \
    ports { WidthIn_c_din { O 16 vector } WidthIn_c_num_data_valid { I 2 vector } WidthIn_c_fifo_cap { I 2 vector } WidthIn_c_full_n { I 1 bit } WidthIn_c_write { O 1 bit } } \
} "
}
...
# RegSlice definition:
set ID 53
set RegSliceName bd_eab1_hsc_0_regslice_both
set RegSliceInstName bd_eab1_hsc_0_regslice_both_U
set CoreName ap_simcore_bd_eab1_hsc_0_regslice_both
