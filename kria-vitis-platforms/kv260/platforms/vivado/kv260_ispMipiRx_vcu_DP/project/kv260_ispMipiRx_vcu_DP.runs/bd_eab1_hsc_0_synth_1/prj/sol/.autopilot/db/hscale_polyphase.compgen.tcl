...
set id 100
set name bd_eab1_hsc_0_mux_83_8_1_1
...
set id 118
set name bd_eab1_hsc_0_mac_muladd_8ns_16s_12ns_24_4_1
...
set id 121
set name bd_eab1_hsc_0_mac_muladd_8ns_16s_24s_25_4_1
set corename simcore_mac
set op mac
set stage_num 4
set clk_width 1
...
set id 124
set name bd_eab1_hsc_0_mac_muladd_8ns_16s_25s_26_4_1
set corename simcore_mac
set op mac
set stage_num 4
set clk_width 1
...
set id 127
set name bd_eab1_hsc_0_mac_muladd_8ns_16s_26s_26_4_1
set corename simcore_mac
set op mac
set stage_num 4
set clk_width 1
...
set id 130
set name bd_eab1_hsc_0_mac_muladd_8ns_16s_26s_27_4_1
set corename simcore_mac
set op mac
set stage_num 4
set clk_width 1
...
set ce_signed 0
set out_width 27
set arg_lists {i0 {8 0 +} i1 {16 1 +} m {24 1 +} i2 {26 1 +} p {27 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp48} LATENCY 3 ALLOW_PRAGMA 1
}
...
set id 133
set name bd_eab1_hsc_0_mac_muladd_8ns_16s_27s_27_4_1
set corename simcore_mac
set op mac
set stage_num 4
set clk_width 1
...
set ce_signed 0
set out_width 27
set arg_lists {i0 {8 0 +} i1 {16 1 +} m {24 1 +} i2 {27 1 +} p {27 1 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {all} IMPL {dsp48} LATENCY 3 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename FiltCoeff_0 \
    op interface \
    ports { FiltCoeff_0_address0 { O 6 vector } FiltCoeff_0_ce0 { O 1 bit } FiltCoeff_0_q0 { I 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'FiltCoeff_0'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_PhasesH_0_read \
    op interface \
    ports { PhasesH_0_read { I 6 vector } } \
} "
}
