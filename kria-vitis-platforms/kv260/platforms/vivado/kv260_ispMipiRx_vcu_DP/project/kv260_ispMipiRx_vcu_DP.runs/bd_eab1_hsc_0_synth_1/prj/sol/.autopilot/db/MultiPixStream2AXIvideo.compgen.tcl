...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { stream_out_420_dout { I 24 vector } stream_out_420_num_data_valid { I 5 vector } stream_out_420_fifo_cap { I 5 vector } stream_out_420_empty_n { I 1 bit } stream_out_420_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_ColorModeOut \
    op interface \
    ports { ColorModeOut_dout { I 8 vector } ColorModeOut_num_data_valid { I 4 vector } ColorModeOut_fifo_cap { I 4 vector } ColorModeOut_empty_n { I 1 bit } ColorModeOut_read { O 1 bit } } \
} "
}
