; ModuleID = '/home/user/Documents/kria-vitis-platforms/kv260/platforms/vivado/kv260_ispMipiRx_vcu_DP/project/kv260_ispMipiRx_vcu_DP.runs/bd_eab1_hsc_0_synth_1/prj/sol/.autopilot/db/a.g.ld.5.gdce.bc'
...
entry:
  ...
  %phasesH_copy = alloca [1920 x i9], align 512
  ...
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* nonnull %s_axis_video, i24* %s_axis_video_copy.data, i3* %s_axis_video_copy.keep, i3* %s_axis_video_copy.strb, i1* %s_axis_video_copy.user, i1* %s_axis_video_copy.last, i1* %s_axis_video_copy.id, i1* %s_axis_video_copy.dest, i16* nonnull %Height, i16* nonnull align 512 %Height_copy, i16* nonnull %WidthIn, i16* nonnull align 512 %WidthIn_copy, i16* nonnull %WidthOut, i16* nonnull align 512 %WidthOut_copy, i8* nonnull %ColorMode, i8* nonnull align 512 %ColorMode_copy, i32* nonnull %PixelRate, i32* nonnull align 512 %PixelRate_copy, i8* nonnull %ColorModeOut, i8* nonnull align 512 %ColorModeOut_copy, [64 x [6 x i16]]* nonnull %0, [64 x [6 x i16]]* nonnull align 512 %hfltCoeff_copy, [1920 x %"struct.ap_uint<9>"]* nonnull %1, [1920 x i9]* nonnull align 512 %phasesH_copy, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* nonnull %m_axis_video, i24* %m_axis_video_copy.data, i3* %m_axis_video_copy.keep, i3* %m_axis_video_copy.strb, i1* %m_axis_video_copy.user, i1* %m_axis_video_copy.last, i1* %m_axis_video_copy.id, i1* %m_axis_video_copy.dest)
  %2 = getelementptr inbounds [64 x [6 x i16]], [64 x [6 x i16]]* %hfltCoeff_copy, i32 0, i32 0
  %3 = getelementptr [1920 x i9], [1920 x i9]* %phasesH_copy, i32 0, i32 0
  call void @apatb_v_hscaler_hw(i24* %s_axis_video_copy.data, i3* %s_axis_video_copy.keep, i3* %s_axis_video_copy.strb, i1* %s_axis_video_copy.user, i1* %s_axis_video_copy.last, i1* %s_axis_video_copy.id, i1* %s_axis_video_copy.dest, i16* %Height_copy, i16* %WidthIn_copy, i16* %WidthOut_copy, i8* %ColorMode_copy, i32* %PixelRate_copy, i8* %ColorModeOut_copy, [6 x i16]* %2, i9* %3, i24* %m_axis_video_copy.data, i3* %m_axis_video_copy.keep, i3* %m_axis_video_copy.strb, i1* %m_axis_video_copy.user, i1* %m_axis_video_copy.last, i1* %m_axis_video_copy.id, i1* %m_axis_video_copy.dest)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %s_axis_video, i24* %s_axis_video_copy.data, i3* %s_axis_video_copy.keep, i3* %s_axis_video_copy.strb, i1* %s_axis_video_copy.user, i1* %s_axis_video_copy.last, i1* %s_axis_video_copy.id, i1* %s_axis_video_copy.dest, i16* %Height, i16* %Height_copy, i16* %WidthIn, i16* %WidthIn_copy, i16* %WidthOut, i16* %WidthOut_copy, i8* %ColorMode, i8* %ColorMode_copy, i32* %PixelRate, i32* %PixelRate_copy, i8* %ColorModeOut, i8* %ColorModeOut_copy, [64 x [6 x i16]]* %0, [64 x [6 x i16]]* %hfltCoeff_copy, [1920 x %"struct.ap_uint<9>"]* %1, [1920 x i9]* %phasesH_copy, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %m_axis_video, i24* %m_axis_video_copy.data, i3* %m_axis_video_copy.keep, i3* %m_axis_video_copy.strb, i1* %m_axis_video_copy.user, i1* %m_axis_video_copy.last, i1* %m_axis_video_copy.id, i1* %m_axis_video_copy.dest)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* noalias "unpacked"="0", i24* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.0" %_V_data_V, i3* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.1" %_V_keep_V, i3* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.2" %_V_strb_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.4" %_V_last_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.5" %_V_id_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.6" %_V_dest_V, i16* noalias readonly "unpacked"="2", i16* noalias align 512 "unpacked"="3", i16* noalias readonly "unpacked"="4", i16* noalias align 512 "unpacked"="5", i16* noalias readonly "unpacked"="6", i16* noalias align 512 "unpacked"="7", i8* noalias readonly "unpacked"="8", i8* noalias align 512 "unpacked"="9", i32* noalias readonly "unpacked"="10", i32* noalias align 512 "unpacked"="11", i8* noalias readonly "unpacked"="12", i8* noalias align 512 "unpacked"="13", [64 x [6 x i16]]* noalias readonly "unpacked"="14", [64 x [6 x i16]]* noalias align 512 "unpacked"="15", [1920 x %"struct.ap_uint<9>"]* noalias readonly "unpacked"="16", [1920 x i9]* noalias nocapture align 512 "unpacked"="17.0.0.0", %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* noalias "unpacked"="18", i24* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.0" %_V_data_V1, i3* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.1" %_V_keep_V2, i3* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.2" %_V_strb_V3, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.3" %_V_user_V4, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.4" %_V_last_V5, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.5" %_V_id_V6, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.6" %_V_dest_V7) unnamed_addr #1 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"(i24* %_V_data_V, i3* %_V_keep_V, i3* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i1* %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %0)
  ...
  call fastcc void @"onebyonecpy_hls.p0a1920struct.ap_uint<9>"([1920 x i9]* align 512 %16, [1920 x %"struct.ap_uint<9>"]* %15)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"(i24* %_V_data_V1, i3* %_V_keep_V2, i3* %_V_strb_V3, i1* %_V_user_V4, i1* %_V_last_V5, i1* %_V_id_V6, i1* %_V_dest_V7, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %17)
  ret void
}
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* noalias "unpacked"="0", i24* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.0" %_V_data_V, i3* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.1" %_V_keep_V, i3* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.2" %_V_strb_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.4" %_V_last_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.5" %_V_id_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.6" %_V_dest_V, i16* noalias "unpacked"="2", i16* noalias readonly align 512 "unpacked"="3", i16* noalias "unpacked"="4", i16* noalias readonly align 512 "unpacked"="5", i16* noalias "unpacked"="6", i16* noalias readonly align 512 "unpacked"="7", i8* noalias "unpacked"="8", i8* noalias readonly align 512 "unpacked"="9", i32* noalias "unpacked"="10", i32* noalias readonly align 512 "unpacked"="11", i8* noalias "unpacked"="12", i8* noalias readonly align 512 "unpacked"="13", [64 x [6 x i16]]* noalias "unpacked"="14", [64 x [6 x i16]]* noalias readonly align 512 "unpacked"="15", [1920 x %"struct.ap_uint<9>"]* noalias "unpacked"="16", [1920 x i9]* noalias nocapture readonly align 512 "unpacked"="17.0.0.0", %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* noalias "unpacked"="18", i24* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.0" %_V_data_V1, i3* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.1" %_V_keep_V2, i3* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.2" %_V_strb_V3, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.3" %_V_user_V4, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.4" %_V_last_V5, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.5" %_V_id_V6, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.6" %_V_dest_V7) unnamed_addr #3 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>.72"(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %0, i24* %_V_data_V, i3* %_V_keep_V, i3* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i1* %_V_dest_V)
  ...
  call fastcc void @"onebyonecpy_hls.p0a1920struct.ap_uint<9>.23"([1920 x %"struct.ap_uint<9>"]* %15, [1920 x i9]* align 512 %16)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>.72"(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %17, i24* %_V_data_V1, i3* %_V_keep_V2, i3* %_V_strb_V3, i1* %_V_user_V4, i1* %_V_last_V5, i1* %_V_id_V6, i1* %_V_dest_V7)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a1920struct.ap_uint<9>.23"([1920 x %"struct.ap_uint<9>"]* noalias "unpacked"="0", [1920 x i9]* noalias nocapture readonly align 512 "unpacked"="1.0.0.0") unnamed_addr #2 {
entry:
...
for.loop:                                         ; preds = %for.loop, %copy
  ...
  %src.addr.0.0.05 = getelementptr [1920 x i9], [1920 x i9]* %1, i64 0, i64 %for.loop.idx1
  %dst.addr.0.0.06 = getelementptr [1920 x %"struct.ap_uint<9>"], [1920 x %"struct.ap_uint<9>"]* %0, i64 0, i64 %for.loop.idx1, i32 0, i32 0, i32 0
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0a1920struct.ap_uint<9>"([1920 x i9]* noalias nocapture align 512 "unpacked"="0.0.0.0", [1920 x %"struct.ap_uint<9>"]* noalias readonly "unpacked"="1") unnamed_addr #2 {
entry:
  %2 = icmp eq [1920 x %"struct.ap_uint<9>"]* %1, null
  br i1 %2, label %ret, label %copy
...
for.loop:                                         ; preds = %for.loop, %copy
  %for.loop.idx1 = phi i64 [ 0, %copy ], [ %for.loop.idx.next, %for.loop ]
  %src.addr.0.0.05 = getelementptr [1920 x %"struct.ap_uint<9>"], [1920 x %"struct.ap_uint<9>"]* %1, i64 0, i64 %for.loop.idx1, i32 0, i32 0, i32 0
  %dst.addr.0.0.06 = getelementptr [1920 x i9], [1920 x i9]* %0, i64 0, i64 %for.loop.idx1
  %3 = bitcast i9* %src.addr.0.0.05 to i16*
  %4 = load i16, i16* %3
  %5 = trunc i16 %4 to i9
  store i9 %5, i9* %dst.addr.0.0.06, align 2
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"(i24* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.0" %_V_data_V, i3* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.1" %_V_keep_V, i3* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.2" %_V_strb_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.4" %_V_last_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.5" %_V_id_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* noalias "fpga.caller.interfaces"="layout_transformed") unnamed_addr #4 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>.68"(i24* %_V_data_V, i3* %_V_keep_V, i3* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i1* %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* nonnull %0)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>.68"(i24* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.0" %_V_data_V, i3* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.1" %_V_keep_V, i3* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.2" %_V_strb_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.3" %_V_user_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.4" %_V_last_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.5" %_V_id_V, i1* noalias nocapture "fpga.caller.interfaces"="layout_transformed" "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* noalias nocapture "fpga.caller.interfaces"="layout_transformed") unnamed_addr #5 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>.72"(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* noalias align 512 "fpga.caller.interfaces"="layout_transformed", i24* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.0" %_V_data_V, i3* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.1" %_V_keep_V, i3* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.2" %_V_strb_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.4" %_V_last_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.5" %_V_id_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.6" %_V_dest_V) unnamed_addr #4 {
entry:
  %1 = icmp eq %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %0, null
  %2 = or i1 %1, false
  br i1 %2, label %ret, label %copy
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>.75"(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* nonnull align 512 %0, i24* %_V_data_V, i3* %_V_keep_V, i3* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i1* %_V_dest_V)
  br label %ret
...
declare void @apatb_v_hscaler_hw(i24*, i3*, i3*, i1*, i1*, i1*, i1*, i16*, i16*, i16*, i8*, i32*, i8*, [6 x i16]*, i9*, i24*, i3*, i3*, i1*, i1*, i1*, i1*)

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_back(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* noalias "unpacked"="0", i24* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.0" %_V_data_V, i3* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.1" %_V_keep_V, i3* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.2" %_V_strb_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.3" %_V_user_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.4" %_V_last_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.5" %_V_id_V, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="1.6" %_V_dest_V, i16* noalias "unpacked"="2", i16* noalias readonly align 512 "unpacked"="3", i16* noalias "unpacked"="4", i16* noalias readonly align 512 "unpacked"="5", i16* noalias "unpacked"="6", i16* noalias readonly align 512 "unpacked"="7", i8* noalias "unpacked"="8", i8* noalias readonly align 512 "unpacked"="9", i32* noalias "unpacked"="10", i32* noalias readonly align 512 "unpacked"="11", i8* noalias "unpacked"="12", i8* noalias readonly align 512 "unpacked"="13", [64 x [6 x i16]]* noalias "unpacked"="14", [64 x [6 x i16]]* noalias readonly align 512 "unpacked"="15", [1920 x %"struct.ap_uint<9>"]* noalias "unpacked"="16", [1920 x i9]* noalias nocapture readonly align 512 "unpacked"="17.0.0.0", %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* noalias "unpacked"="18", i24* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.0" %_V_data_V1, i3* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.1" %_V_keep_V2, i3* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.2" %_V_strb_V3, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.3" %_V_user_V4, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.4" %_V_last_V5, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.5" %_V_id_V6, i1* noalias "fpga.caller.interfaces"="layout_transformed" "unpacked"="19.6" %_V_dest_V7) unnamed_addr #3 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>.72"(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %0, i24* %_V_data_V, i3* %_V_keep_V, i3* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i1* %_V_dest_V)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>.72"(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %17, i24* %_V_data_V1, i3* %_V_keep_V2, i3* %_V_strb_V3, i1* %_V_user_V4, i1* %_V_last_V5, i1* %_V_id_V6, i1* %_V_dest_V7)
  ret void
...
define void @v_hscaler_hw_stub_wrapper(i24*, i3*, i3*, i1*, i1*, i1*, i1*, i16*, i16*, i16*, i8*, i32*, i8*, [6 x i16]*, i9*, i24*, i3*, i3*, i1*, i1*, i1*, i1*) #6 {
entry:
  %22 = alloca %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"
  %23 = alloca [1920 x %"struct.ap_uint<9>"]
  %24 = alloca %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"
  %25 = bitcast [6 x i16]* %13 to [64 x [6 x i16]]*
  %26 = bitcast i9* %14 to [1920 x i9]*
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %22, i24* %0, i3* %1, i3* %2, i1* %3, i1* %4, i1* %5, i1* %6, i16* null, i16* %7, i16* null, i16* %8, i16* null, i16* %9, i8* null, i8* %10, i32* null, i32* %11, i8* null, i8* %12, [64 x [6 x i16]]* null, [64 x [6 x i16]]* %25, [1920 x %"struct.ap_uint<9>"]* %23, [1920 x i9]* %26, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %24, i24* %15, i3* %16, i3* %17, i1* %18, i1* %19, i1* %20, i1* %21)
  %27 = bitcast [64 x [6 x i16]]* %25 to [6 x i16]*
  %28 = bitcast [1920 x %"struct.ap_uint<9>"]* %23 to %"struct.ap_uint<9>"*
  call void @v_hscaler_hw_stub(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %22, i16* %7, i16* %8, i16* %9, i8* %10, i32* %11, i8* %12, [6 x i16]* %27, %"struct.ap_uint<9>"* %28, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %24)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %22, i24* %0, i3* %1, i3* %2, i1* %3, i1* %4, i1* %5, i1* %6, i16* null, i16* %7, i16* null, i16* %8, i16* null, i16* %9, i8* null, i8* %10, i32* null, i32* %11, i8* null, i8* %12, [64 x [6 x i16]]* null, [64 x [6 x i16]]* %25, [1920 x %"struct.ap_uint<9>"]* %23, [1920 x i9]* %26, %"class.hls::stream<hls::axis<ap_uint<24>, 1, 1, 1>, 0>"* %24, i24* %15, i3* %16, i3* %17, i1* %18, i1* %19, i1* %20, i1* %21)
  ret void
}
