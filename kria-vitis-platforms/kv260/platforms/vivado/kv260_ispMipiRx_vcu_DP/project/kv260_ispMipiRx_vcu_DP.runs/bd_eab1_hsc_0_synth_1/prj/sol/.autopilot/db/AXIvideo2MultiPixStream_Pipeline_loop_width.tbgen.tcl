...
set C_modelArgList {
	...
	{ axi_data_V_2 int 24 regular  }
	{ WidthIn_load_cast int 11 regular {ap_stable 0} }
	{ icmp_ln1435 int 1 regular  }
	{ icmp_ln1435_1 int 1 regular  }
	...
	{ axi_data_V_3_out int 24 regular {pointer 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "sof_4", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_V_2", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "WidthIn_load_cast", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
 	{ "Name" : "icmp_ln1435", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "icmp_ln1435_1", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "axi_data_V_3_out", "interface" : "wire", "bitwidth" : 24, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ stream_in_din sc_out sc_lv 24 signal 6 } 
	{ stream_in_num_data_valid sc_in sc_lv 5 signal 6 } 
	{ stream_in_fifo_cap sc_in sc_lv 5 signal 6 } 
	{ stream_in_full_n sc_in sc_logic 1 signal 6 } 
	{ stream_in_write sc_out sc_logic 1 signal 6 } 
	{ sof_4 sc_in sc_lv 1 signal 0 } 
	{ axi_last_V_2 sc_in sc_lv 1 signal 1 } 
	{ axi_data_V_2 sc_in sc_lv 24 signal 2 } 
	{ WidthIn_load_cast sc_in sc_lv 11 signal 3 } 
	{ icmp_ln1435 sc_in sc_lv 1 signal 4 } 
	{ icmp_ln1435_1 sc_in sc_lv 1 signal 5 } 
	{ s_axis_video_TDATA sc_in sc_lv 24 signal 7 } 
	{ s_axis_video_TREADY sc_out sc_logic 1 inacc 13 } 
	{ s_axis_video_TKEEP sc_in sc_lv 3 signal 8 } 
	{ s_axis_video_TSTRB sc_in sc_lv 3 signal 9 } 
	{ s_axis_video_TUSER sc_in sc_lv 1 signal 10 } 
	{ s_axis_video_TLAST sc_in sc_lv 1 signal 11 } 
	{ s_axis_video_TID sc_in sc_lv 1 signal 12 } 
	{ s_axis_video_TDEST sc_in sc_lv 1 signal 13 } 
	{ eol_out sc_out sc_lv 1 signal 14 } 
	{ eol_out_ap_vld sc_out sc_logic 1 outvld 14 } 
	{ axi_data_V_3_out sc_out sc_lv 24 signal 15 } 
	{ axi_data_V_3_out_ap_vld sc_out sc_logic 1 outvld 15 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "axi_data_V_2", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "axi_data_V_2", "role": "default" }} , 
 	{ "name": "WidthIn_load_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "WidthIn_load_cast", "role": "default" }} , 
 	{ "name": "icmp_ln1435", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "icmp_ln1435", "role": "default" }} , 
 	{ "name": "icmp_ln1435_1", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "icmp_ln1435_1", "role": "default" }} , 
 	...
 	{ "name": "axi_data_V_3_out", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "axi_data_V_3_out", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "18", "Max" : "1922"}
	, {"Name" : "Interval", "Min" : "18", "Max" : "1922"}
]}
...
set Spec2ImplPortList { 
	...
	axi_data_V_2 { ap_none {  { axi_data_V_2 in_data 0 24 } } }
	WidthIn_load_cast { ap_stable {  { WidthIn_load_cast in_data 0 11 } } }
	icmp_ln1435 { ap_none {  { icmp_ln1435 in_data 0 1 } } }
	icmp_ln1435_1 { ap_none {  { icmp_ln1435_1 in_data 0 1 } } }
	...
	axi_data_V_3_out { ap_vld {  { axi_data_V_3_out out_data 1 24 }  { axi_data_V_3_out_ap_vld out_vld 1 1 } } }
}
