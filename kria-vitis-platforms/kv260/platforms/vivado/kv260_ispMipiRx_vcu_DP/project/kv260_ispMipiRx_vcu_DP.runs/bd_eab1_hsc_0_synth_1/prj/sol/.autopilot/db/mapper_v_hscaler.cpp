...
using hls::sim::Byte;
extern "C" void v_hscaler(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, Byte<2>*, Byte<2>*, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
...
auto* ss_axis_video_V_dest_V = createStream((hls::stream<char>*)__xlx_apatb_param_s_axis_video_V_dest_V);
  // Collect __xlx_hfltCoeff__tmp_vec
std::vector<Byte<2>> __xlx_hfltCoeff__tmp_vec;
for (size_t i = 0; i < 384; ++i){
__xlx_hfltCoeff__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_hfltCoeff)[i]);
}
  int __xlx_size_param_hfltCoeff = 384;
  int __xlx_offset_param_hfltCoeff = 0;
  int __xlx_offset_byte_param_hfltCoeff = 0*2;
  // Collect __xlx_phasesH__tmp_vec
std::vector<Byte<2>> __xlx_phasesH__tmp_vec;
for (size_t i = 0; i < 1920; ++i){
__xlx_phasesH__tmp_vec.push_back(((Byte<2>*)__xlx_apatb_param_phasesH)[i]);
}
  int __xlx_size_param_phasesH = 1920;
  int __xlx_offset_param_phasesH = 0;
  int __xlx_offset_byte_param_phasesH = 0*2;
...
auto* sm_axis_video_V_dest_V = createStream((hls::stream<char>*)__xlx_apatb_param_m_axis_video_V_dest_V);
  // DUT call
  v_hscaler(ss_axis_video_V_data_V->data<int>(), ss_axis_video_V_keep_V->data<char>(), ss_axis_video_V_strb_V->data<char>(), ss_axis_video_V_user_V->data<char>(), ss_axis_video_V_last_V->data<char>(), ss_axis_video_V_id_V->data<char>(), ss_axis_video_V_dest_V->data<char>(), __xlx_apatb_param_Height, __xlx_apatb_param_WidthIn, __xlx_apatb_param_WidthOut, __xlx_apatb_param_ColorMode, __xlx_apatb_param_PixelRate, __xlx_apatb_param_ColorModeOut, __xlx_hfltCoeff__tmp_vec.data(), __xlx_phasesH__tmp_vec.data(), sm_axis_video_V_data_V->data<int>(), sm_axis_video_V_keep_V->data<char>(), sm_axis_video_V_strb_V->data<char>(), sm_axis_video_V_user_V->data<char>(), sm_axis_video_V_last_V->data<char>(), sm_axis_video_V_id_V->data<char>(), sm_axis_video_V_dest_V->data<char>());
...
// print __xlx_apatb_param_hfltCoeff
for (size_t i = 0; i < __xlx_size_param_hfltCoeff; ++i) {
((Byte<2>*)__xlx_apatb_param_hfltCoeff)[i] = __xlx_hfltCoeff__tmp_vec[__xlx_offset_param_hfltCoeff+i];
}
// print __xlx_apatb_param_phasesH
for (size_t i = 0; i < __xlx_size_param_phasesH; ++i) {
((Byte<2>*)__xlx_apatb_param_phasesH)[i] = __xlx_phasesH__tmp_vec[__xlx_offset_param_phasesH+i];
}
