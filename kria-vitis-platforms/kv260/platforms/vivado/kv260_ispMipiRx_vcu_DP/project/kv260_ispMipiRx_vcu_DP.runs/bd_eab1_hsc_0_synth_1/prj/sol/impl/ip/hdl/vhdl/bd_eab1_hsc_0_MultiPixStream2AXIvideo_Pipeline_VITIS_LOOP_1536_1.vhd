...
entity bd_eab1_hsc_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_1536_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of bd_eab1_hsc_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_1536_1 is 
...
attribute shreg_extract : string;
    ...
    signal i_1_reg_204 : STD_LOGIC_VECTOR (1 downto 0);
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal icmp_ln1536_reg_208 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal map_V_3_cast_fu_160_p1 : STD_LOGIC_VECTOR (4 downto 0);
    ...
    component bd_eab1_hsc_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_1536_1_mapComp_ROM_AUTO_1R IS
    generic (
        DataWidth : INTEGER;
...
begin
    mapComp_U : component bd_eab1_hsc_0_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_1536_1_mapComp_ROM_AUTO_1R
    generic map (
        DataWidth => 2,
        AddressRange => 12,
        AddressWidth => 4)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                icmp_ln1536_reg_208 <= icmp_ln1536_fu_104_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln1536_reg_208 = ap_const_lv1_0) and (i_1_reg_204 = ap_const_lv2_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                    map_V_1_fu_48(1 downto 0) <= map_V_3_cast_fu_160_p1(1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((icmp_ln1536_reg_208 = ap_const_lv1_0) and (i_1_reg_204 = ap_const_lv2_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                    map_V_2_fu_52(1 downto 0) <= map_V_3_cast_fu_160_p1(1 downto 0);
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not((i_1_reg_204 = ap_const_lv2_0)) and not((i_1_reg_204 = ap_const_lv2_1)) and (icmp_ln1536_reg_208 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                    map_V_fu_44(1 downto 0) <= map_V_3_cast_fu_160_p1(1 downto 0);
            end if;
        end if;
    end process;
    ...
    map_V_1_out <= map_V_1_fu_48(2 - 1 downto 0);

    map_V_1_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, icmp_ln1536_reg_208)
    begin
        if (((icmp_ln1536_reg_208 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    map_V_2_out <= map_V_2_fu_52(2 - 1 downto 0);

    map_V_2_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, icmp_ln1536_reg_208)
    begin
        if (((icmp_ln1536_reg_208 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    map_V_3_cast_fu_160_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(mapComp_q0),5));
    map_V_out <= map_V_fu_44(2 - 1 downto 0);

    map_V_out_ap_vld_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_block_pp0_stage0_11001, icmp_ln1536_reg_208)
    begin
        if (((icmp_ln1536_reg_208 = ap_const_lv1_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
