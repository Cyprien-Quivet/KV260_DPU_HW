    ...
    reg ap_done_reg_1;// for module v_csc_core_U0
    always @ (negedge dl_reset or posedge dl_clock) begin
        if (~dl_reset) begin
            ap_done_reg_1 <= 'b0;
        end
        else begin
            ap_done_reg_1 <= v_csc_core_U0.ap_done & ~v_csc_core_U0.ap_continue;
        end
    end

    reg ap_done_reg_2;// for module v_hcresampler_core_1_U0
    always @ (negedge dl_reset or posedge dl_clock) begin
        if (~dl_reset) begin
            ap_done_reg_2 <= 'b0;
        end
        else begin
            ap_done_reg_2 <= v_hcresampler_core_1_U0.ap_done & ~v_hcresampler_core_1_U0.ap_continue;
        end
    end

    reg ap_done_reg_3;// for module v_vcresampler_core_U0
    always @ (negedge dl_reset or posedge dl_clock) begin
        if (~dl_reset) begin
            ap_done_reg_3 <= 'b0;
        end
        else begin
            ap_done_reg_3 <= v_vcresampler_core_U0.ap_done & ~v_vcresampler_core_U0.ap_continue;
        end
    end

reg [15:0] trans_in_cnt_0;// for process Block_entry1_proc_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_in_cnt_0 <= 16'h0;
    end
    else if (Block_entry1_proc_U0.start_write == 1'b1) begin
...
reg [15:0] trans_out_cnt_0;// for process Block_entry1_proc_U0
always @(negedge dl_reset or posedge dl_clock) begin
    if (~dl_reset) begin
         trans_out_cnt_0 <= 16'h0;
    end
    else if (Block_entry1_proc_U0.ap_done == 1'b1 && Block_entry1_proc_U0.ap_continue == 1'b1) begin
    ...
    bd_eab1_hsc_0_hls_deadlock_detect_unit #(8, 0, 7, 4) bd_eab1_hsc_0_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_data_FIFO_blk[0] = 1'b0 | (~Block_entry1_proc_U0.ColorMode_c_blk_n);
    ...
    assign proc_0_data_FIFO_blk[1] = 1'b0 | (~Block_entry1_proc_U0.ColorModeOut_c_blk_n);
    assign proc_0_data_PIPO_blk[1] = 1'b0;
    assign proc_0_start_FIFO_blk[1] = 1'b0 | (~start_for_MultiPixStream2AXIvideo_U0_U.if_full_n & Block_entry1_proc_U0.ap_start & ~Block_entry1_proc_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_MultiPixStream2AXIvideo_U0_U.if_read);
    ...
    assign proc_0_input_sync_blk[2] = 1'b0 | (ap_sync_Block_entry1_proc_U0_ap_ready & Block_entry1_proc_U0.ap_idle & ~ap_sync_AXIvideo2MultiPixStream_U0_ap_ready);
    ...
    assign proc_0_input_sync_blk[3] = 1'b0 | (ap_sync_Block_entry1_proc_U0_ap_ready & Block_entry1_proc_U0.ap_idle & ~ap_sync_hscale_core_polyphase_U0_ap_ready);
    ...
    bd_eab1_hsc_0_hls_deadlock_detect_unit #(8, 1, 3, 3) bd_eab1_hsc_0_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~AXIvideo2MultiPixStream_U0.grp_AXIvideo2MultiPixStream_Pipeline_loop_width_fu_200.stream_in_blk_n) | (~AXIvideo2MultiPixStream_U0.Height_c20_blk_n) | (~AXIvideo2MultiPixStream_U0.WidthIn_c_blk_n);
    ...
    assign proc_1_input_sync_blk[1] = 1'b0 | (ap_sync_AXIvideo2MultiPixStream_U0_ap_ready & AXIvideo2MultiPixStream_U0.ap_idle & ~ap_sync_Block_entry1_proc_U0_ap_ready);
    ...
    assign proc_1_input_sync_blk[2] = 1'b0 | (ap_sync_AXIvideo2MultiPixStream_U0_ap_ready & AXIvideo2MultiPixStream_U0.ap_idle & ~ap_sync_hscale_core_polyphase_U0_ap_ready);
    ...
    bd_eab1_hsc_0_hls_deadlock_detect_unit #(8, 2, 2, 3) bd_eab1_hsc_0_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~v_hcresampler_core_U0.grp_v_hcresampler_core_Pipeline_VITIS_LOOP_1636_2_fu_162.stream_in_blk_n) | (~v_hcresampler_core_U0.Height_blk_n) | (~v_hcresampler_core_U0.WidthIn_blk_n);
    ...
    assign proc_2_TLF_FIFO_blk[1] = 1'b0 | (~bPassThruHcr1_channel_U.if_empty_n & v_hcresampler_core_U0.ap_idle & ~bPassThruHcr1_channel_U.if_write);
    assign proc_2_input_sync_blk[1] = 1'b0;
    assign proc_2_output_sync_blk[1] = 1'b0;
    assign proc_dep_vld_vec_2[1] = dl_detect_out ? proc_dep_vld_vec_2_reg[1] : (proc_2_data_FIFO_blk[1] | proc_2_data_PIPO_blk[1] | proc_2_start_FIFO_blk[1] | proc_2_TLF_FIFO_blk[1] | proc_2_input_sync_blk[1] | proc_2_output_sync_blk[1]);
    assign proc_2_data_FIFO_blk[2] = 1'b0 | (~v_hcresampler_core_U0.grp_v_hcresampler_core_Pipeline_VITIS_LOOP_1636_2_fu_162.stream_upsampled_blk_n);
    ...
    bd_eab1_hsc_0_hls_deadlock_detect_unit #(8, 3, 4, 4) bd_eab1_hsc_0_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~hscale_core_polyphase_U0.grp_hscale_core_polyphase_Pipeline_loop_width_fu_264.stream_upsampled_blk_n);
    ...
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~hscale_core_polyphase_U0.grp_hscale_core_polyphase_Pipeline_loop_width_fu_264.stream_scaled_blk_n) | (~hscale_core_polyphase_U0.Height_c19_blk_n) | (~hscale_core_polyphase_U0.WidthOut_c23_blk_n);
    ...
    assign proc_3_input_sync_blk[2] = 1'b0 | (ap_sync_hscale_core_polyphase_U0_ap_ready & hscale_core_polyphase_U0.ap_idle & ~ap_sync_Block_entry1_proc_U0_ap_ready);
    ...
    assign proc_3_input_sync_blk[3] = 1'b0 | (ap_sync_hscale_core_polyphase_U0_ap_ready & hscale_core_polyphase_U0.ap_idle & ~ap_sync_AXIvideo2MultiPixStream_U0_ap_ready);
    ...
    bd_eab1_hsc_0_hls_deadlock_detect_unit #(8, 4, 3, 3) bd_eab1_hsc_0_hls_deadlock_detect_unit_4 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_4_data_FIFO_blk[0] = 1'b0 | (~v_csc_core_U0.grp_v_csc_core_Pipeline_VITIS_LOOP_2035_2_fu_114.stream_scaled_blk_n) | (~v_csc_core_U0.Height_blk_n) | (~v_csc_core_U0.WidthOut_blk_n);
    ...
    assign proc_4_data_FIFO_blk[1] = 1'b0 | (~v_csc_core_U0.ColorMode_blk_n);
    assign proc_4_data_PIPO_blk[1] = 1'b0;
    assign proc_4_start_FIFO_blk[1] = 1'b0;
    assign proc_4_TLF_FIFO_blk[1] = 1'b0 | (~bPassThruCsc_channel_U.if_empty_n & v_csc_core_U0.ap_idle & ~bPassThruCsc_channel_U.if_write);
    assign proc_4_input_sync_blk[1] = 1'b0;
    assign proc_4_output_sync_blk[1] = 1'b0;
    assign proc_dep_vld_vec_4[1] = dl_detect_out ? proc_dep_vld_vec_4_reg[1] : (proc_4_data_FIFO_blk[1] | proc_4_data_PIPO_blk[1] | proc_4_start_FIFO_blk[1] | proc_4_TLF_FIFO_blk[1] | proc_4_input_sync_blk[1] | proc_4_output_sync_blk[1]);
    assign proc_4_data_FIFO_blk[2] = 1'b0 | (~v_csc_core_U0.grp_v_csc_core_Pipeline_VITIS_LOOP_2035_2_fu_114.stream_scaled_csc_blk_n) | (~v_csc_core_U0.Height_c18_blk_n) | (~v_csc_core_U0.WidthOut_c22_blk_n);
    ...
    bd_eab1_hsc_0_hls_deadlock_detect_unit #(8, 5, 2, 3) bd_eab1_hsc_0_hls_deadlock_detect_unit_5 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_5_data_FIFO_blk[0] = 1'b0 | (~v_hcresampler_core_1_U0.grp_v_hcresampler_core_1_Pipeline_VITIS_LOOP_1636_2_fu_198.stream_scaled_csc_blk_n) | (~v_hcresampler_core_1_U0.Height_blk_n) | (~v_hcresampler_core_1_U0.WidthOut_blk_n);
    ...
    assign proc_5_TLF_FIFO_blk[1] = 1'b0 | (~bPassThruHcr2_channel_U.if_empty_n & v_hcresampler_core_1_U0.ap_idle & ~bPassThruHcr2_channel_U.if_write);
    assign proc_5_input_sync_blk[1] = 1'b0;
    assign proc_5_output_sync_blk[1] = 1'b0;
    assign proc_dep_vld_vec_5[1] = dl_detect_out ? proc_dep_vld_vec_5_reg[1] : (proc_5_data_FIFO_blk[1] | proc_5_data_PIPO_blk[1] | proc_5_start_FIFO_blk[1] | proc_5_TLF_FIFO_blk[1] | proc_5_input_sync_blk[1] | proc_5_output_sync_blk[1]);
    assign proc_5_data_FIFO_blk[2] = 1'b0 | (~v_hcresampler_core_1_U0.grp_v_hcresampler_core_1_Pipeline_VITIS_LOOP_1636_2_fu_198.stream_out_422_blk_n) | (~v_hcresampler_core_1_U0.Height_c17_blk_n) | (~v_hcresampler_core_1_U0.WidthOut_c21_blk_n);
    ...
    bd_eab1_hsc_0_hls_deadlock_detect_unit #(8, 6, 2, 3) bd_eab1_hsc_0_hls_deadlock_detect_unit_6 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_6_data_FIFO_blk[0] = 1'b0 | (~v_vcresampler_core_U0.grp_v_vcresampler_core_Pipeline_VITIS_LOOP_1853_2_fu_142.stream_out_422_blk_n) | (~v_vcresampler_core_U0.Height_blk_n) | (~v_vcresampler_core_U0.WidthOut_blk_n);
    ...
    assign proc_6_TLF_FIFO_blk[1] = 1'b0 | (~bPassThruVcr_channel_U.if_empty_n & v_vcresampler_core_U0.ap_idle & ~bPassThruVcr_channel_U.if_write);
    assign proc_6_input_sync_blk[1] = 1'b0;
    assign proc_6_output_sync_blk[1] = 1'b0;
    assign proc_dep_vld_vec_6[1] = dl_detect_out ? proc_dep_vld_vec_6_reg[1] : (proc_6_data_FIFO_blk[1] | proc_6_data_PIPO_blk[1] | proc_6_start_FIFO_blk[1] | proc_6_TLF_FIFO_blk[1] | proc_6_input_sync_blk[1] | proc_6_output_sync_blk[1]);
    assign proc_6_data_FIFO_blk[2] = 1'b0 | (~v_vcresampler_core_U0.grp_v_vcresampler_core_Pipeline_VITIS_LOOP_1853_2_fu_142.stream_out_420_blk_n) | (~v_vcresampler_core_U0.Height_c_blk_n) | (~v_vcresampler_core_U0.WidthOut_c_blk_n);
    ...
    bd_eab1_hsc_0_hls_deadlock_detect_unit #(8, 7, 2, 2) bd_eab1_hsc_0_hls_deadlock_detect_unit_7 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_7_data_FIFO_blk[0] = 1'b0 | (~MultiPixStream2AXIvideo_U0.grp_MultiPixStream2AXIvideo_Pipeline_VITIS_LOOP_1544_3_fu_154.stream_out_420_blk_n) | (~MultiPixStream2AXIvideo_U0.Height_blk_n) | (~MultiPixStream2AXIvideo_U0.WidthOut_blk_n);
    ...
    assign proc_7_data_FIFO_blk[1] = 1'b0 | (~MultiPixStream2AXIvideo_U0.ColorModeOut_blk_n);
    assign proc_7_data_PIPO_blk[1] = 1'b0;
    assign proc_7_start_FIFO_blk[1] = 1'b0 | (~start_for_MultiPixStream2AXIvideo_U0_U.if_empty_n & MultiPixStream2AXIvideo_U0.ap_idle & ~start_for_MultiPixStream2AXIvideo_U0_U.if_write);
...
`include "bd_eab1_hsc_0_hls_deadlock_report_unit.vh"
