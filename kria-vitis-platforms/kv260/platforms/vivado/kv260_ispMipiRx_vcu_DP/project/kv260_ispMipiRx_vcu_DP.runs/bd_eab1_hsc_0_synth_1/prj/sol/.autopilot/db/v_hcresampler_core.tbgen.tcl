...
set portList { 
	...
	{ WidthIn_num_data_valid sc_in sc_lv 2 signal 2 } 
	{ WidthIn_fifo_cap sc_in sc_lv 2 signal 2 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "stream_in", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_hcresampler_core_Pipeline_VITIS_LOOP_1636_2_fu_162", "Port" : "stream_in", "Inst_start_state" : "4", "Inst_end_state" : "5"}]},
			...
			{"Name" : "stream_upsampled", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "16", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_v_hcresampler_core_Pipeline_VITIS_LOOP_1636_2_fu_162", "Port" : "stream_upsampled", "Inst_start_state" : "4", "Inst_end_state" : "5"}]}],
		"Loop" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_v_hcresampler_core_Pipeline_VITIS_LOOP_1636_2_fu_162", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_v_hcresampler_core_Pipeline_VITIS_LOOP_1636_2_fu_162.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	WidthIn { ap_fifo {  { WidthIn_dout fifo_port_we 0 16 }  { WidthIn_num_data_valid fifo_status_num_data_valid 0 2 }  { WidthIn_fifo_cap fifo_update 0 2 }  { WidthIn_empty_n fifo_status 0 1 }  { WidthIn_read fifo_data 1 1 } } }
