...
module bd_eab1_vsc_0_hls_deadlock_idx0_monitor ( // for module bd_eab1_vsc_0_v_vscaler_inst
    input wire clock,
    input wire reset,
...
// instant sub module
 bd_eab1_vsc_0_hls_deadlock_idx1_monitor bd_eab1_vsc_0_hls_deadlock_idx1_monitor_U (
    .clock(clock),
    .reset(reset),
