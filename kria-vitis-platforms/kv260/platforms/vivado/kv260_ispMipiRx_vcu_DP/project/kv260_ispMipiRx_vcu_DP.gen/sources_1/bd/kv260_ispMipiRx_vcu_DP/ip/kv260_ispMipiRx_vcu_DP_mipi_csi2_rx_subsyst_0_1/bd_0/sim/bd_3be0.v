...
//--------------------------------------------------------------------------------
//Command: generate_target bd_3be0.bd
//Design : bd_3be0
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_3be0,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_3be0,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "kv260_ispMipiRx_vcu_DP_mipi_csi2_rx_subsyst_0_1.hwdef" *) 
module bd_3be0
   (clkoutphy_out,
    csirxss_csi_irq,
  ...
  assign csirxss_s_axi_1_ARADDR = csirxss_s_axi_araddr[12:0];
  assign csirxss_s_axi_1_ARPROT = csirxss_s_axi_arprot[2:0];
  assign csirxss_s_axi_1_ARVALID = csirxss_s_axi_arvalid[0];
  assign csirxss_s_axi_1_AWADDR = csirxss_s_axi_awaddr[12:0];
