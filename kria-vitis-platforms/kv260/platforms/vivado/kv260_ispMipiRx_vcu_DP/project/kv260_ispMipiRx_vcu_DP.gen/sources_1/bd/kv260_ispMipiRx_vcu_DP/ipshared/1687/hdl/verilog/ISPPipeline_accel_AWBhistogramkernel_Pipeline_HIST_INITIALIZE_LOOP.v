...
module ISPPipeline_accel_AWBhistogramkernel_Pipeline_HIST_INITIALIZE_LOOP (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_ready_int;
wire   [63:0] zext_ln1027_fu_154_p1;
reg   [10:0] i_V_fu_46;
wire   [10:0] add_ln840_fu_148_p2;
wire    ap_loop_init;
reg   [10:0] ap_sig_allocacmp_i_V_7;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
        if ((icmp_ln1027_fu_142_p2 == 1'd0)) begin
...
always @ (*) begin
    if (((icmp_ln1027_fu_142_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if (((icmp_ln1027_fu_142_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
assign add_ln840_fu_148_p2 = (ap_sig_allocacmp_i_V_7 + 11'd1);
...
assign icmp_ln1027_fu_142_p2 = ((ap_sig_allocacmp_i_V_7 == 11'd1024) ? 1'b1 : 1'b0);

assign tmp_hist1_V_1_address0 = zext_ln1027_fu_154_p1;

assign tmp_hist1_V_1_d0 = 32'd0;

assign tmp_hist1_V_2_address0 = zext_ln1027_fu_154_p1;

assign tmp_hist1_V_2_d0 = 32'd0;

assign tmp_hist1_V_address0 = zext_ln1027_fu_154_p1;

assign tmp_hist1_V_d0 = 32'd0;

assign tmp_hist_V_1_address0 = zext_ln1027_fu_154_p1;

assign tmp_hist_V_1_d0 = 32'd0;

assign tmp_hist_V_2_address0 = zext_ln1027_fu_154_p1;

assign tmp_hist_V_2_d0 = 32'd0;

assign tmp_hist_V_address0 = zext_ln1027_fu_154_p1;

assign tmp_hist_V_d0 = 32'd0;

assign zext_ln1027_fu_154_p1 = ap_sig_allocacmp_i_V_7;

endmodule //ISPPipeline_accel_AWBhistogramkernel_Pipeline_HIST_INITIALIZE_LOOP
