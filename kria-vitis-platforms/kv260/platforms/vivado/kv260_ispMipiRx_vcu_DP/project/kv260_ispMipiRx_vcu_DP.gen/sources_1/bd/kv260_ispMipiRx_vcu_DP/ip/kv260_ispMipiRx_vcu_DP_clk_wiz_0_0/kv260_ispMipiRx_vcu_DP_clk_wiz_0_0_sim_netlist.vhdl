...
-- Date        : Fri Mar  6 02:22:12 2026
-- Host        : ubuntu running 64-bit Ubuntu 20.04.6 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/user/Documents/kria-vitis-platforms/kv260/platforms/vivado/kv260_ispMipiRx_vcu_DP/project/kv260_ispMipiRx_vcu_DP.gen/sources_1/bd/kv260_ispMipiRx_vcu_DP/ip/kv260_ispMipiRx_vcu_DP_clk_wiz_0_0/kv260_ispMipiRx_vcu_DP_clk_wiz_0_0_sim_netlist.vhdl
...
entity kv260_ispMipiRx_vcu_DP_clk_wiz_0_0_clk_wiz is
  port (
...
end kv260_ispMipiRx_vcu_DP_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of kv260_ispMipiRx_vcu_DP_clk_wiz_0_0_clk_wiz is
  signal clk_100M_kv260_ispMipiRx_vcu_DP_clk_wiz_0_0 : STD_LOGIC;
  signal clk_200M_kv260_ispMipiRx_vcu_DP_clk_wiz_0_0 : STD_LOGIC;
  signal clk_50M_kv260_ispMipiRx_vcu_DP_clk_wiz_0_0 : STD_LOGIC;
  signal clk_600M_kv260_ispMipiRx_vcu_DP_clk_wiz_0_0 : STD_LOGIC;
  signal clk_in1_kv260_ispMipiRx_vcu_DP_clk_wiz_0_0 : STD_LOGIC;
  signal clkv_200M_kv260_ispMipiRx_vcu_DP_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_bufg: unisim.vcomponents.BUFGCE
    generic map(
      ...
      CE => '1',
      I => clk_in1,
      O => clk_in1_kv260_ispMipiRx_vcu_DP_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_200M_kv260_ispMipiRx_vcu_DP_clk_wiz_0_0,
      O => clk_200M
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_100M_kv260_ispMipiRx_vcu_DP_clk_wiz_0_0,
      O => clk_100M
    );
clkout3_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clkv_200M_kv260_ispMipiRx_vcu_DP_clk_wiz_0_0,
      O => clkv_200M
    );
clkout4_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_50M_kv260_ispMipiRx_vcu_DP_clk_wiz_0_0,
      O => clk_50M
    );
clkout5_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_600M_kv260_ispMipiRx_vcu_DP_clk_wiz_0_0,
      O => clk_600M
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_kv260_ispMipiRx_vcu_DP_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_200M_kv260_ispMipiRx_vcu_DP_clk_wiz_0_0,
      CLKOUT0B => NLW_mmcme4_adv_inst_CLKOUT0B_UNCONNECTED,
      CLKOUT1 => clk_100M_kv260_ispMipiRx_vcu_DP_clk_wiz_0_0,
      CLKOUT1B => NLW_mmcme4_adv_inst_CLKOUT1B_UNCONNECTED,
      CLKOUT2 => clkv_200M_kv260_ispMipiRx_vcu_DP_clk_wiz_0_0,
      CLKOUT2B => NLW_mmcme4_adv_inst_CLKOUT2B_UNCONNECTED,
      CLKOUT3 => clk_50M_kv260_ispMipiRx_vcu_DP_clk_wiz_0_0,
      CLKOUT3B => NLW_mmcme4_adv_inst_CLKOUT3B_UNCONNECTED,
      CLKOUT4 => clk_600M_kv260_ispMipiRx_vcu_DP_clk_wiz_0_0,
...
entity kv260_ispMipiRx_vcu_DP_clk_wiz_0_0 is
  ...
  attribute NotValidForBitStream of kv260_ispMipiRx_vcu_DP_clk_wiz_0_0 : entity is true;
end kv260_ispMipiRx_vcu_DP_clk_wiz_0_0;

architecture STRUCTURE of kv260_ispMipiRx_vcu_DP_clk_wiz_0_0 is
begin
inst: entity work.kv260_ispMipiRx_vcu_DP_clk_wiz_0_0_clk_wiz
     port map (
      clk_100M => clk_100M,
      clk_200M => clk_200M,
      clk_50M => clk_50M,
