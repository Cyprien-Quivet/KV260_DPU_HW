...
module ISPPipeline_accel_AWBNormalizationkernel_Pipeline_VITIS_LOOP_332_3 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire  signed [32:0] conv_i_i1531_cast_fu_259_p1;
reg  signed [32:0] conv_i_i1531_cast_reg_410;
...
wire   [0:0] icmp_ln1420_fu_351_p2;
...
wire   [32:0] zext_ln186_23_fu_301_p1;
wire   [32:0] zext_ln186_fu_297_p1;
wire   [32:0] ret_V_fu_304_p2;
wire   [0:0] tmp_fu_315_p3;
wire   [0:0] icmp_ln1027_fu_310_p2;
wire   [0:0] xor_ln1027_fu_322_p2;
...
always @ (posedge ap_clk) begin
    if ((~(j_read_reg_404 == 2'd0) & ~(j_read_reg_404 == 2'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1420_fu_351_p2 == 1'd1) & (1'd1 == and_ln332_reg_447))) begin
        ap_phi_reg_pp0_iter1_empty_286_reg_175 <= 18'd0;
    end else if ((((j_read_reg_404 == 2'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1420_fu_351_p2 == 1'd1) & (1'd1 == and_ln332_reg_447)) | ((j_read_reg_404 == 2'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1420_fu_351_p2 == 1'd1) & (1'd1 == and_ln332_reg_447)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1420_fu_351_p2 == 1'd0) & (1'd1 == and_ln332_reg_447)))) begin
...
always @ (posedge ap_clk) begin
    if (((~(j_read_reg_404 == 2'd0) & ~(j_read_reg_404 == 2'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1420_fu_351_p2 == 1'd1) & (1'd1 == and_ln332_reg_447)) | ((j_read_reg_404 == 2'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1420_fu_351_p2 == 1'd1) & (1'd1 == and_ln332_reg_447)) | ((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1420_fu_351_p2 == 1'd0) & (1'd1 == and_ln332_reg_447)))) begin
        ap_phi_reg_pp0_iter1_empty_287_reg_190 <= minValue_V_3_read_reg_464;
    end else if (((j_read_reg_404 == 2'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1420_fu_351_p2 == 1'd1) & (1'd1 == and_ln332_reg_447))) begin
...
always @ (posedge ap_clk) begin
    if (((j_read_reg_404 == 2'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1420_fu_351_p2 == 1'd1) & (1'd1 == and_ln332_reg_447))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'd1 == and_ln332_reg_447))) begin
        minValue_V_1_reg_484 <= minValue_V_1_fu_357_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage2_11001) & (1'b1 == ap_CS_fsm_pp0_stage2) & (1'd1 == and_ln332_fu_328_p2))) begin
...
always @ (*) begin
    if (((1'd0 == and_ln332_fu_328_p2) & (1'b0 == ap_block_pp0_stage2_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage2))) begin
...
always @ (*) begin
    if (((~(j_read_reg_404 == 2'd0) & ~(j_read_reg_404 == 2'd1) & (1'd1 == and_ln332_reg_447)) | ((j_read_reg_404 == 2'd0) & (1'd1 == and_ln332_reg_447)))) begin
        ap_phi_mux_empty_284_phi_fu_236_p6 = ap_phi_reg_pp0_iter1_empty_287_reg_190;
    end else if (((j_read_reg_404 == 2'd1) & (1'd1 == and_ln332_reg_447))) begin
...
always @ (*) begin
    if (((j_read_reg_404 == 2'd0) & (1'd1 == and_ln332_reg_447))) begin
        ap_phi_mux_empty_285_phi_fu_249_p6 = minValue_V_1_reg_484;
    end else if (((~(j_read_reg_404 == 2'd0) & ~(j_read_reg_404 == 2'd1) & (1'd1 == and_ln332_reg_447)) | ((j_read_reg_404 == 2'd1) & (1'd1 == and_ln332_reg_447)))) begin
...
always @ (*) begin
    if ((~(j_read_reg_404 == 2'd0) & ~(j_read_reg_404 == 2'd1) & (1'd1 == and_ln332_reg_447))) begin
        ap_phi_mux_empty_phi_fu_223_p6 = minValue_V_1_reg_484;
    end else if ((((j_read_reg_404 == 2'd0) & (1'd1 == and_ln332_reg_447)) | ((j_read_reg_404 == 2'd1) & (1'd1 == and_ln332_reg_447)))) begin
...
always @ (*) begin
    if ((((j_read_reg_404 == 2'd1) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'd1 == and_ln332_reg_447)) | ((j_read_reg_404 == 2'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1420_fu_351_p2 == 1'd1) & (1'd1 == and_ln332_reg_447)))) begin
...
always @ (*) begin
    if (((~(j_read_reg_404 == 2'd0) & ~(j_read_reg_404 == 2'd1) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'd1 == and_ln332_reg_447)) | (~(j_read_reg_404 == 2'd0) & ~(j_read_reg_404 == 2'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1420_fu_351_p2 == 1'd1) & (1'd1 == and_ln332_reg_447)))) begin
...
always @ (*) begin
    if ((((j_read_reg_404 == 2'd0) & (1'b0 == ap_block_pp0_stage1_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'd1 == and_ln332_reg_447)) | ((j_read_reg_404 == 2'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1420_fu_351_p2 == 1'd1) & (1'd1 == and_ln332_reg_447)))) begin
...
assign and_ln332_fu_328_p2 = (xor_ln1027_fu_322_p2 & icmp_ln1027_fu_310_p2);
...
always @ (*) begin
    ap_condition_376 = ((j_read_reg_404 == 2'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'd1 == and_ln332_reg_447));
end

always @ (*) begin
    ap_condition_378 = ((1'b0 == ap_block_pp0_stage0_01001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1420_fu_351_p2 == 1'd1));
end

always @ (*) begin
    ap_condition_385 = (~(j_read_reg_404 == 2'd0) & ~(j_read_reg_404 == 2'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'd1 == and_ln332_reg_447));
end

always @ (*) begin
    ap_condition_388 = ((j_read_reg_404 == 2'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'd1 == and_ln332_reg_447));
end
...
assign conv_i_i1531_cast_fu_259_p1 = $signed(conv_i_i1531);

assign hist_0_address0 = zext_ln541_fu_276_p1;

assign hist_1_address0 = zext_ln541_fu_276_p1;

assign hist_2_address0 = zext_ln541_fu_276_p1;

assign icmp_ln1027_fu_310_p2 = ((ret_V_fu_304_p2 < conv_i_i1531_cast_reg_410) ? 1'b1 : 1'b0);

assign icmp_ln1420_fu_351_p2 = ((tmp_7_fu_343_p5 == 18'd262080) ? 1'b1 : 1'b0);
...
assign ret_V_fu_304_p2 = (zext_ln186_23_fu_301_p1 + zext_ln186_fu_297_p1);

assign tmp_fu_315_p3 = p1_V_1_reg_415[32'd10];

assign xor_ln1027_fu_322_p2 = (tmp_fu_315_p3 ^ 1'd1);

assign zext_ln186_23_fu_301_p1 = rhs_V_reg_436;

assign zext_ln186_fu_297_p1 = lhs_V_fu_74;

assign zext_ln541_fu_276_p1 = ap_sig_allocacmp_p1_V_1;

endmodule //ISPPipeline_accel_AWBNormalizationkernel_Pipeline_VITIS_LOOP_332_3
