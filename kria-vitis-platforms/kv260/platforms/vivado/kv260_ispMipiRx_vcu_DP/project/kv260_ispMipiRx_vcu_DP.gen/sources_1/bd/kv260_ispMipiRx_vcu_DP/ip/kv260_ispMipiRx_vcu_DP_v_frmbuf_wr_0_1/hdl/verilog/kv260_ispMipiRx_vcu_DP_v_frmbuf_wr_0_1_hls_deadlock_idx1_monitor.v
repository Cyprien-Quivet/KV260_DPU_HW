...
module kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_hls_deadlock_idx1_monitor ( // for module kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_v_frmbuf_wr_inst.grp_FrmbufWrHlsDataFlow_fu_166
    input wire clock,
    input wire reset,
...
assign process_axis_block_vec[1] = idx2_block & (1'b0 | axis_block_sigs[2] | axis_block_sigs[1] | axis_block_sigs[0]);
...
// instant sub module
 kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_hls_deadlock_idx2_monitor kv260_ispMipiRx_vcu_DP_v_frmbuf_wr_0_1_hls_deadlock_idx2_monitor_U (
    .clock(clock),
    .reset(reset),
