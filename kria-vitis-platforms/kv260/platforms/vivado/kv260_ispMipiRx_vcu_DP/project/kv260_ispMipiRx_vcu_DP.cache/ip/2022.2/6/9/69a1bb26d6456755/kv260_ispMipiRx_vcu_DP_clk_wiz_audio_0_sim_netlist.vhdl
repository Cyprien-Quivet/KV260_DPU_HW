...
-- Date        : Thu Mar  5 01:37:57 2026
-- Host        : ubuntu running 64-bit Ubuntu 20.04.6 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ kv260_ispMipiRx_vcu_DP_clk_wiz_audio_0_sim_netlist.vhdl
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_kv260_ispMipiRx_vcu_DP_clk_wiz_audio_0_clk_wiz is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_kv260_ispMipiRx_vcu_DP_clk_wiz_audio_0_clk_wiz;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_kv260_ispMipiRx_vcu_DP_clk_wiz_audio_0_clk_wiz is
  signal clk_in1_kv260_ispMipiRx_vcu_DP_clk_wiz_audio_0 : STD_LOGIC;
  signal clk_out1_kv260_ispMipiRx_vcu_DP_clk_wiz_audio_0 : STD_LOGIC;
  signal clk_out2_kv260_ispMipiRx_vcu_DP_clk_wiz_audio_0 : STD_LOGIC;
...
clkin1_bufg: unisim.vcomponents.BUFGCE
    generic map(
      ...
      CE => '1',
      I => clk_in1,
      O => clk_in1_kv260_ispMipiRx_vcu_DP_clk_wiz_audio_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_kv260_ispMipiRx_vcu_DP_clk_wiz_audio_0,
      O => clk_out1
    );
clkout2_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out2_kv260_ispMipiRx_vcu_DP_clk_wiz_audio_0,
      O => clk_out2
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      BANDWIDTH => "OPTIMIZED",
      CLKFBOUT_MULT_F => 80.000000,
      ...
      CLKIN1 => clk_in1_kv260_ispMipiRx_vcu_DP_clk_wiz_audio_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_kv260_ispMipiRx_vcu_DP_clk_wiz_audio_0,
      CLKOUT0B => clk_out2_kv260_ispMipiRx_vcu_DP_clk_wiz_audio_0,
...
begin
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_kv260_ispMipiRx_vcu_DP_clk_wiz_audio_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
