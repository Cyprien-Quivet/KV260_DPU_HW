...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { demosaic_out_data216_din { O 30 vector } demosaic_out_data216_num_data_valid { I 3 vector } demosaic_out_data216_fifo_cap { I 3 vector } demosaic_out_data216_full_n { I 1 bit } demosaic_out_data216_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_select_ln303_4 \
    op interface \
    ports { select_ln303_4 { I 2 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_select_ln303_1 \
    op interface \
    ports { select_ln303_1 { I 2 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_select_ln303_7 \
    op interface \
    ports { select_ln303_7 { I 2 vector } } \
} "
}
