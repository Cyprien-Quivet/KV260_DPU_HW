set moduleName AWBNormalizationkernel_Pipeline_VITIS_LOOP_332_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {AWBNormalizationkernel_Pipeline_VITIS_LOOP_332_3}
...
set C_modelArgMapList {[ 
	{ "Name" : "hist_0", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "conv_i_i1531", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ conv_i_i1531 sc_in sc_lv 32 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "conv_i_i1531", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "conv_i_i1531", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	conv_i_i1531 { ap_none {  { conv_i_i1531 in_data 0 32 } } }
