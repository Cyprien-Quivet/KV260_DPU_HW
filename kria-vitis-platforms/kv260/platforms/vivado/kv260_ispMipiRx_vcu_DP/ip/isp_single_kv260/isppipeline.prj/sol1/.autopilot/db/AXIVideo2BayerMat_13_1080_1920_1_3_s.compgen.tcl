...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_axis_video_TDATA { I 16 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { imgInput1_data213_din { O 10 vector } imgInput1_data213_num_data_valid { I 3 vector } imgInput1_data213_fifo_cap { I 3 vector } imgInput1_data213_full_n { I 1 bit } imgInput1_data213_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 57 \
    name imgInput1_rows_c \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_imgInput1_rows_c \
    op interface \
    ports { imgInput1_rows_c_din { O 16 vector } imgInput1_rows_c_num_data_valid { I 2 vector } imgInput1_rows_c_fifo_cap { I 2 vector } imgInput1_rows_c_full_n { I 1 bit } imgInput1_rows_c_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 58 \
    name imgInput1_cols_c \
    type fifo \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_imgInput1_cols_c \
    op interface \
    ports { imgInput1_cols_c_din { O 16 vector } imgInput1_cols_c_num_data_valid { I 2 vector } imgInput1_cols_c_fifo_cap { I 2 vector } imgInput1_cols_c_full_n { I 1 bit } imgInput1_cols_c_write { O 1 bit } } \
} "
}
