...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler ISPPipeline_accel_p_ZL9hist0_awb_0_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 509 \
			corename ISPPipeline_accel_CTRL_axilite \
			name ISPPipeline_accel_CTRL_s_axi \
			ports {$port_CTRL} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler ISPPipeline_accel_CTRL_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
# RegSlice definition:
set ID 524
set RegSliceName ISPPipeline_accel_regslice_both
set RegSliceInstName ISPPipeline_accel_regslice_both_U
set CoreName ap_simcore_ISPPipeline_accel_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
