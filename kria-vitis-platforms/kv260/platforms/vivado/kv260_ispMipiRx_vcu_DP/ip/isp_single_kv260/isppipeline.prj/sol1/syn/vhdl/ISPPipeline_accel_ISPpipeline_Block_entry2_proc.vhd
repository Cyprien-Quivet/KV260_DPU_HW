...
entity ISPPipeline_accel_ISPpipeline_Block_entry2_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of ISPPipeline_accel_ISPpipeline_Block_entry2_proc is 
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
                    ap_return_10_preg <= grp_fu_30_p2;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_return_10_assign_proc : process(ap_CS_fsm_state15, grp_fu_30_p2, ap_return_10_preg)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state15)) then 
            ap_return_10 <= grp_fu_30_p2;
        else 
    ...
    grp_fu_35_ce_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, ap_CS_fsm_state7, ap_CS_fsm_state2, ap_CS_fsm_state3, ap_CS_fsm_state4, ap_CS_fsm_state5, ap_CS_fsm_state6)
    begin
    ...
    grp_fu_35_p0 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(pawb),32));
end behav;
