...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { p_dst_data219_dout { I 24 vector } p_dst_data219_num_data_valid { I 3 vector } p_dst_data219_fifo_cap { I 3 vector } p_dst_data219_empty_n { I 1 bit } p_dst_data219_read { O 1 bit } } \
} "
}
