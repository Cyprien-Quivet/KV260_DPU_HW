...
module ISPPipeline_accel_xf_QuatizationDithering_Pipeline_VITIS_LOOP_118_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln118_fu_94_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] zext_ln118_fu_106_p1;
reg   [15:0] col_index_fu_34;
wire   [15:0] add_ln118_fu_100_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln118_fu_94_p2 == 1'd0)) begin
            col_index_fu_34 <= add_ln118_fu_100_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            col_index_fu_34 <= 16'd0;
        end
    end
end
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln118_fu_94_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln118_fu_94_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln118_fu_100_p2 = (ap_sig_allocacmp_col_index_1 + 16'd1);
...
assign icmp_ln118_fu_94_p2 = ((ap_sig_allocacmp_col_index_1 == p_read1) ? 1'b1 : 1'b0);

assign offset_buffer_V_1_address0 = zext_ln118_fu_106_p1;

assign offset_buffer_V_1_d0 = 9'd0;

assign offset_buffer_V_2_address0 = zext_ln118_fu_106_p1;

assign offset_buffer_V_2_d0 = 9'd0;

assign offset_buffer_V_address0 = zext_ln118_fu_106_p1;

assign offset_buffer_V_d0 = 9'd0;

assign zext_ln118_fu_106_p1 = ap_sig_allocacmp_col_index_1;

endmodule //ISPPipeline_accel_xf_QuatizationDithering_Pipeline_VITIS_LOOP_118_1
