...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { axi_data_V_2 { I 16 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_last_out \
    op interface \
    ports { last_out { O 1 vector } last_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { axi_data_V_3_out { O 16 vector } axi_data_V_3_out_ap_vld { O 1 bit } } \
} "
}
