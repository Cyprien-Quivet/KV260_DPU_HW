...
using hls::sim::Byte;
extern "C" void ISPPipeline_accel(short, short, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, short, short, Byte<1>*, char, short);
...
auto* ss_axis_video_V_data_V = createStream((hls::stream<short>*)__xlx_apatb_param_s_axis_video_V_data_V);
...
for (size_t i = 0; i < __xlx_size_param_gamma_lut; ++i) {
((Byte<1>*)__xlx_apatb_param_gamma_lut)[i] = __xlx_gamma_lut__tmp_vec[__xlx_offset_param_gamma_lut+i];
}
}
